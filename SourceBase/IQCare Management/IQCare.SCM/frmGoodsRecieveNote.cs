...
namespace IQCare.SCM
{
    public partial class frmGoodsRecieveNote : Form
    {
        ...
        private DataTable CreateGRNItemTable()
        {
            ...
            dtGRNItem.Columns.Add("CustomPurchasePrice", typeof(decimal));
            dtGRNItem.Columns.Add("CustomMargin", typeof(decimal));            
            dtGRNItem.Columns.Add("CustomSellingPrice", typeof(decimal));
        ...
        private void BindGrid()
        {
            try
            {
                ...
                theColumnOrderQuantity.HeaderText = "Order Quantity";
                ...
                theColumnUnits.HeaderText = "Purchase Units";
        ...
        private void BindGrnItemsGrid()
        {
            try
            {
                ...
                theColumnAutoId.ReadOnly = false;
                ...
                theColumnItemID.Name = "ItemID";
                theColumnItemID.Width = 50;
                theColumnItemID.ReadOnly = false;
                ...
                theColumnBatchID.Name = "BatchID";
                theColumnBatchID.Width = 100;
                theColumnBatchID.ReadOnly = false;
                ...
                theColumnQtyPerPurchaseUnit.ReadOnly = false;
                ...
                theColumnItemPurchasePrice.Width = 75;
                ...
                theColumnTotPurchasePrice.Width = 75;
                ...
                theColumnMasterPurchasePrice.Width = 75;
                ...
                ///Custom Price with Batches////
                DataGridViewTextBoxColumn theCustomPurchasePrice = new DataGridViewTextBoxColumn();
                theCustomPurchasePrice.HeaderText = "Custom Purchase Price";
                theCustomPurchasePrice.DataPropertyName = "CustomPurchasePrice";
                theCustomPurchasePrice.Name = "CustomPurchasePrice";
                theCustomPurchasePrice.Width = 75;
                theCustomPurchasePrice.ReadOnly = false;

                DataGridViewTextBoxColumn theCustomMargin = new DataGridViewTextBoxColumn();
                theCustomMargin.HeaderText = "Customize Margin %";
                theCustomMargin.DataPropertyName = "CustomMargin";
                theCustomMargin.Name = "CustomMargin";
                theCustomMargin.Width = 75;
                theCustomMargin.ReadOnly = false;


                DataGridViewTextBoxColumn theCustomSellingPrice = new DataGridViewTextBoxColumn();
                theCustomSellingPrice.HeaderText = "Customize Selling Price/ Purchase Unit";
                theCustomSellingPrice.DataPropertyName = "CustomSellingPrice";
                theCustomSellingPrice.Name = "CustomSellingPrice";
                theCustomSellingPrice.Width = 100;
                //theCustomSellingPrice.ReadOnly = true;
                ...
                ///////Customize Columns ///////////////////////
                dgwGRNItems.Columns.Add(theCustomPurchasePrice);
                dgwGRNItems.Columns.Add(theCustomMargin);
                dgwGRNItems.Columns.Add(theCustomSellingPrice);
                if (GblIQCare.ModePurchaseOrder == 2)
                {
        ...
        private void dgwGRNItems_EditingControlShowing(object sender, DataGridViewEditingControlShowingEventArgs e)
        {
            ...
            if (dgwDataGridForEvent.CurrentCell.ColumnIndex == 15)
            {
                TextBox txttItemCustomPurchasePrice = e.Control as TextBox;
                if (txttItemCustomPurchasePrice != null)
                {
                    txttItemCustomPurchasePrice.AutoCompleteCustomSource = null;
                    txttItemCustomPurchasePrice.KeyPress += new KeyPressEventHandler(txtValidation_KeyPress);
                }
            }
            if (dgwDataGridForEvent.CurrentCell.ColumnIndex == 16)
            {
                TextBox txttItemCustomMargin = e.Control as TextBox;
                if (txttItemCustomMargin != null)
                {
                    txttItemCustomMargin.AutoCompleteCustomSource = null;
                    txttItemCustomMargin.KeyPress += new KeyPressEventHandler(txtValidation_KeyPress);
                }
            }
        }
        ...
        void txtValidation_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            else if (dgwGRNItems.CurrentCell.ColumnIndex == 8 || dgwGRNItems.CurrentCell.ColumnIndex == 15 || dgwGRNItems.CurrentCell.ColumnIndex == 16)
            {
        ...
        private bool FillGridItemToSave()
        {
            ...
            if (GridItemCount == itemcount)
            {
                if (GridItemCount > 0)
                {
                    foreach (DataRow drGrid in theDVGridItem.Table.Rows)
                    {
                        foreach (DataRow drGRN in theDVGrnItem.Table.Rows)
                        {
                            if (drGRN["BatchId"].ToString() == drGrid["BatchId"].ToString())
                            {
                                if (drGrid["CustomPurchasePrice"] != null)
                                {
                                    drGRN["CustomPurchasePrice"] = Convert.ToDecimal(drGrid["CustomPurchasePrice"]);
                                    drGRN["CustomMargin"] = Convert.ToDecimal(drGrid["CustomMargin"]);
                                    drGRN["CustomSellingPrice"] = Convert.ToDecimal(drGrid["CustomSellingPrice"]);
                                }
            ...
            else
            {
                ...
                for (int i = 0; i < dgwGRNItems.Rows.Count; i++)
                {
                    ...
                    if (Convert.ToString(dgwGRNItems.Rows[i].Cells["BatchName"].Value) != "")
                    {
                        ...
                        {
                            DataRow row = dtGRNItem.Select("BatchId=" + dgwGRNItems.Rows[i].Cells["BatchID"].Value).FirstOrDefault();
                            row["CustomPurchasePrice"] = Convert.ToDecimal(dgwGRNItems.Rows[i].Cells["CustomPurchasePrice"].Value);
                            row["CustomMargin"] = Convert.ToDecimal(dgwGRNItems.Rows[i].Cells["CustomMargin"].Value);
                            row["CustomSellingPrice"] = Convert.ToDecimal(dgwGRNItems.Rows[i].Cells["CustomSellingPrice"].Value);
        ...
        private void dgwGRNItems_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            if (row != null)
            {
                ...
                if (Convert.ToInt32(GrnId) > 0)
                {
                    //dgwGRNItems.Rows[e.RowIndex].ReadOnly = false;
                    //row.Cells["CustomPurchasePrice"].ReadOnly = false;
                    //row.Cells["CustomMargin"].ReadOnly = false;
                    //dgwGRNItems.Rows[row.Cells["CustomPurchasePrice"].ColumnIndex].ReadOnly = false;
                    //dgwGRNItems.Rows[row.Cells["CustomMargin"].ColumnIndex].ReadOnly = false;
        ...
        private void dgwGRNItems_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex > -1 && e.RowIndex > -1)
            {
                ...
                if (dgwDataGrid.Columns[e.ColumnIndex].Name == "RecievedQuantity" && dgwDataGrid.Rows[e.RowIndex].Cells["RecievedQuantity"].Value != null)
                {
                    ...
                    {                       
                        dgwDataGrid.Rows[e.RowIndex].Cells["TotPurchasePrice"].Value = Convert.ToDecimal(dgwDataGrid.Rows[e.RowIndex].Cells["RecievedQuantity"].Value) * Convert.ToDecimal(dgwDataGrid.Rows[e.RowIndex].Cells["ItemPurchasePrice"].Value);
                        if (Convert.ToString(dgwDataGrid.Rows[e.RowIndex].Cells["CustomPurchasePrice"].Value) != "" && Convert.ToString(dgwDataGrid.Rows[e.RowIndex].Cells["RecievedQuantity"].Value) != "")
                        {
                            dgwDataGrid.Rows[e.RowIndex].Cells["CustomSellingPrice"].Value = (Convert.ToDecimal(dgwDataGrid.Rows[e.RowIndex].Cells["RecievedQuantity"].Value) * Convert.ToDecimal(dgwDataGrid.Rows[e.RowIndex].Cells["CustomPurchasePrice"].Value) + (Convert.ToDecimal(dgwDataGrid.Rows[e.RowIndex].Cells["RecievedQuantity"].Value) * Convert.ToDecimal(dgwDataGrid.Rows[e.RowIndex].Cells["CustomPurchasePrice"].Value) * (Convert.ToDecimal(dgwDataGrid.Rows[e.RowIndex].Cells["CustomMargin"].Value) / 100)));
                        }
                    }
                }
                if ((dgwDataGrid.Columns[e.ColumnIndex].Name == "CustomMargin") || (dgwDataGrid.Columns[e.ColumnIndex].Name == "CustomPurchasePrice"))
                {
                    if (dgwDataGrid.Rows[e.RowIndex].Cells["CustomMargin"].Value != null && dgwDataGrid.Rows[e.RowIndex].Cells["CustomMargin"].Value != null)
                    {
                        if (Convert.ToString(dgwDataGrid.Rows[e.RowIndex].Cells["CustomPurchasePrice"].Value) != "" && Convert.ToString(dgwDataGrid.Rows[e.RowIndex].Cells["RecievedQuantity"].Value) != "" && Convert.ToString(dgwDataGrid.Rows[e.RowIndex].Cells["CustomMargin"].Value) != "")
                        {
                            dgwDataGrid.Rows[e.RowIndex].Cells["CustomSellingPrice"].Value = (Convert.ToDecimal(dgwDataGrid.Rows[e.RowIndex].Cells["CustomPurchasePrice"].Value) + (Convert.ToDecimal(dgwDataGrid.Rows[e.RowIndex].Cells["CustomPurchasePrice"].Value) * (Convert.ToDecimal(dgwDataGrid.Rows[e.RowIndex].Cells["CustomMargin"].Value) / 100)));
                        }
                    }
                }
                if(e.ColumnIndex ==6)
                   ...
                   // DataTable theDTItems = (DataTable)dgwDataGrid.DataSource;
                    for (int i = 0; i < dgwDataGrid.Rows.Count; i++)
                    {
                        ...
                        if (tempreceiveQuantity > OrderQuantity)
                        {
                            ...
                            dgwDataGrid.Rows[i].Cells["CustomPurchasePrice"].Value = 0;
                            dgwDataGrid.Rows[i].Cells["CustomMargin"].Value = 0;
                            dgwDataGrid.Rows[i].Cells["CustomSellingPrice"].Value = 0;
                          //  theDTItems.Rows[i]["TotPurchasePrice"] = 0;
       ...
       // }
        ...
        private void AddDefaultrow()
        {
            ...
            if (thetempDVItem.Count > 0)
            {
             ...
             //   theDRowItem["AutoID"] = 1000;
                ...
                theDRowItem["CustomPurchasePrice"] = Convert.ToDecimal(thetempDVItem[0]["CustomPurchasePrice"]);
                theDRowItem["CustomMargin"] = Convert.ToDecimal(thetempDVItem[0]["CustomMargin"]);
                theDRowItem["CustomSellingPrice"] = Convert.ToDecimal(thetempDVItem[0]["CustomSellingPrice"]);
        ...
        private void dgwGRNItems_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
