     ...
     //   bool IsHandleAdded;
        ...
        private void BindSupplierDropdown()
        {
            ...
            try
            {
                ...
                //BindFunctions theBind = new BindFunctions();
                //theBind.Win_BindCombo(ddlSupplier, theDT, "SupplierName", "Id");
            }
            catch (Exception err)
            {
        ...
        private void BindStoreName()
        {
            ...
            ////theDVSource.RowFilter = "CentralStore=1 and DeleteFlag=0 and Id=" + StoreID;
            ////DataTable theDTSource = theDVSource.ToTable();
            ////ddlSourceStore.DataSource = theDTSource;
        ...
        private void BindGrid(DataSet theDS)
        {
            try
            {
               ...
               // theColumnDelete.ReadOnly = true;
                ...
                //    theColumnBatchName.HeaderText = "Batch Name";
                ...
                //    theColumnAvailableQTY.HeaderText = "Available Quantity";
       ...
       // TextBox txtItem;
        private void dgwItemSubitemDetails_EditingControlShowing(object sender, DataGridViewEditingControlShowingEventArgs e)
        {
            ...
            //if (dgwDataGridForEvent.CurrentCell.ColumnIndex == 0)
            //{
            //    txtItem = e.Control as TextBox;
            //    if (txtItem != null)
            //    {
            //        txtItem.KeyUp += new KeyEventHandler(txtItem_KeyUp);
            //    }
            //}
                ...
                if (theGrdCombo.Focused == true && theGrdCombo.SelectedValue != null)
                {
                    ...
                    if (theGrdCombo.DataSource != null && theGrdCombo.SelectedValue.GetType().ToString() != "System.Data.DataRowView")
                    {
                            ...
                            if (dtRow.Rows.Count > 0)
                            {
                                if (!deletedGridByKey)
                                {
                                    dgwItemSubitemDetails.CurrentRow.Cells["ItemCode"].Value = dtRow.Rows[0]["FDACode"].ToString();
