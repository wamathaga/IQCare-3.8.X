...
namespace Application.Presentation
{
    public class IQCareUtils
    {
        ...
        public DataTable GetDataTable(string MasterTableName, string fieldName)
        {
            ...
            IKNHAdultIE AdultIEManager = (IKNHAdultIE)ObjectFactory.CreateInstance("BusinessProcess.Clinical.BAdultIE, BusinessProcess.Clinical");
            theResult = (DataTable)AdultIEManager.GetDataTable(MasterTableName, fieldName);
            return theResult;
