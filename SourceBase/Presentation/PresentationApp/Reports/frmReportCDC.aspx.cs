...
public partial class frmReportCDC : LogPage
{
    ...
    private void writeCellWiseInExcel_HivExposedInfants(Excel.SpreadsheetClass thesheet)
    {
        try
        {
    ...
    private void writeCellWiseInExcel_OGAC(Excel.SpreadsheetClass thesheet)
    {
        try
        {
    ...
    private void writeCellWiseInExcel_Track10(Excel.SpreadsheetClass thesheet)
    {
        try
        {
    ...
    private void writeCellWiseInExcel_MRReport(Excel.SpreadsheetClass thesheet)
    {
        try
        {
    ...
    private void writeInCell(Excel.SpreadsheetClass theSheet, string cell, string tablename, string column)
    {
        ...
        //{
        //    Excel.Range theRange = theSheet.Cells.get_Range(cell, cell);
        //    theRange.Application.AutoFit = true; 
        //   if(column == "")
