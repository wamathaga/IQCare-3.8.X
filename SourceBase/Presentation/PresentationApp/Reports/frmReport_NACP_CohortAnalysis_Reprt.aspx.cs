...
public partial class Reports_frmReport_NACP_CohortAnalysis_Reprt : LogPage
{
    DateTime theYear;
    ...
    private void writeCellWiseInExcelSixCohort(Excel.SpreadsheetClass theSheet)
    {
        try
        {
    ...
    private void writeInCells(Excel.SpreadsheetClass theSheet, string cell, string tablename, string column)
    {
