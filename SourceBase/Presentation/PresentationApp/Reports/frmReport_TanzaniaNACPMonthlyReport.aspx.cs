...
public partial class Reports_frmReport_TanzaniaNACPMonthlyReport : LogPage
{
    DateTime theYear;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ((rdoMonth.Checked == true) || (rdoQuarter.Checked == true))
            RegisterStartupScript("onload", "<script language='javascript' defer ='defer' id = 'scriptonload'>btnEnabledDisabled();</script>");
