...
namespace IQCare.Web.Billing
{
    public partial class frmBilling_ClientBill : LogPage
    {
        ...
        bool CanWriteOff
        {
            get
            {
                return (Authentication.HasFeatureRight(ApplicationAccess.BillingWriteOffBill, (DataTable)Session["UserRight"]) == true);
            }
        }
        /// <summary>
        ...
        bool CanReceivePayment
        {
            get
            {
                return (Authentication.HasFeatureRight(ApplicationAccess.BillingReceivePayment, (DataTable)Session["UserRight"]) == true);
            }
        }
        /// <summary>
        /// 
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            this.ReverseTransaction.PatientID = Convert.ToInt32(Session["PatientId"]);
            ...
            this.PDControl.PatientID = Convert.ToInt32(Session["PatientId"]);
            this.PDControl.LocationID = Convert.ToInt32(Session["AppLocationId"]);
        ...
        private void saveBillInformation()
        {
            try
            {
                ...
                BillingManager = (IBilling)ObjectFactory.CreateInstance("BusinessProcess.SCM.BBilling, BusinessProcess.SCM");
        ...
        protected void grdUnBilledItems_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("AddItem"))
            {
                try
                {
                    ...
                    GridViewRow gridRow = (GridViewRow)(((LinkButton)e.CommandSource).NamingContainer);
                    ...
                    theDR.SetField("PatientID", base.Session["PatientId"]);
        ...
        protected void grdUnBilledItems_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (serviceStatus == "1")
                    {
                        LinkButton btnEdit = (LinkButton)e.Row.FindControl("buttonEdit");
                        btnEdit.Visible = false;
                        //disable the delete button too

                        LinkButton btnDelete = (LinkButton)e.Row.FindControl("buttonDelete");
        ...
        protected void GenerateBill_Click(object sender, EventArgs e)
        {
                ...
                if (gridRow.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (chk != null && chk.Checked && chk.Enabled)
                    {
                        ...
                        if (thisRow != null)
                        {
                            ...
                            decimal amount = decimal.Parse(thisRow["Amount"].ToString());
            ...
            if (itemChecked > 0)
            {
                try
                {
                    IBilling objBilling = (IBilling)ObjectFactory.CreateInstance("BusinessProcess.SCM.BBilling,BusinessProcess.SCM");
                ...
                {
                    this.NotifyAction("Attempt to generate bill failed+ " + ex.Message + " Successfully ..", string.Format("Bill Generated {0} ", "Failure"), false);
                }
            }else
                this.NotifyAction("No item has been selected, please select item ", "Bill generation failed ", true);
            ...
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (print != null)
                    {
                        ...
                        string urlParam = String.Format("openReportPage('./frmBilling_Reports.aspx?BillRefCode={0}&RptCd=Invoice');return false;", _billID);
        ...
        void transactionGrid_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    {
                        Application.Common.Utility objUtil = new Application.Common.Utility();
                        string urlParam = String.Format("openReportPage('./frmBilling_Reciept.aspx?ReceiptTrxCode={0}&RePrint=true');return false;", _transactionID);
