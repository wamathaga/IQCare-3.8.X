                    ...
                    <td>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="border pad5 whitebg" align="left">
                                            ...
                                            <asp:TextBox ID="txtlastName" MaxLength="40" onchange="fnshow();" onblur="fnshow();"
                                                runat="server"></asp:TextBox>
                                        </td>
                                        <td class="border pad5 whitebg" width="28%" align="left">
                                            <label id="lblIQRef">
                                                IQCare Reference:</label>
                                            <asp:TextBox ID="txtIQCareRef" MaxLength="11" runat="server" Width="90%" TabIndex="100"
                                    ...
                                    <tr>
                                        <td class="border pad5 whitebg leftallign" nowrap="nowrap">
                                            ...
                                            <label id="lblDOB" class="required margin15" for="DOB">
                                                Date of Birth:</label>
                                            <asp:TextBox ID="TxtDOB" MaxLength="11" runat="server" Width="90px"></asp:TextBox>
                                            <img onclick="w_displayDatePicker('<%= TxtDOB.ClientID %>');" height="22" alt="Date Helper"
                                                hspace="3" src="./images/cal_icon.gif" width="20" border="0" style="vertical-align: top;
                                                margin-top: -2px;" />
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td class="border pad6 whitebg" align="center" width="48%">
                                                        ...
                                                        <asp:TextBox ID="txtRegDate" runat="server" MaxLength="11" Width="90px" onblur="javascript:ValidateAge()"></asp:TextBox>
                                                        <img alt="Date Helper" border="0" height="22" hspace="3" style="vertical-align: bottom;
                                                            margin-bottom: 2px;" onclick="w_displayDatePicker('<%= txtRegDate.ClientID %>');"
                                                            src="images/cal_icon.gif" width="20" />
                                                        <span class="smallerlabel">DD-MMM-YYYY </span>
                                                    </td>
                                                </tr>
                                            </table>
                        ...
                        <div class="border center formbg">
                            ...
                            <asp:Button ID="btncontinue" runat="server" Text="Continue" OnClick="btncontinue_Click"
                                CssClass="btn btn-primary" Height="30px" Width="11%" Style="text-align: left;" /><label
