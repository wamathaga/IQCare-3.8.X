...
{
    public partial class frmDynamicLab : LogPage
    {
        /// <summary>
        ...
        private Table createTestTable(String department)
        {
            ...
            foreach (DataRow r in theDT.Rows)
            {
                testTable.Rows.Add(CreateTestRow(r));
            }
        ...
        /// <returns></returns>
        private TableRow CreateTestRow(DataRow dr)
        {
            TableRow testRow = new TableRow();
            testRow.CssClass = "border leftallign1 whitebg";
            TableCell testName = new TableCell();
            ...
            if (r.Length > 0)//select list item
            {
                ...
                ddlResults.ID = strTestName.Replace(" ", "_");
            ...
            else
            {
                ...
                txtResults.ID = strTestName.Replace(" ", "_");
