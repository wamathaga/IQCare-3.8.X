...
public partial class Laboratory_LabOrder : BasePage 
{
    ...
    DataSet theDSLabs;
    DataTable theAddLabs;
    ILabMst Labs;
    int PatientId, OrderId;
    int labmasterid;
    DataSet theExistDS = new DataSet();
    DataTable theDTLabReported = new DataTable();
            ...
            if (y.GetType() == typeof(System.Web.UI.WebControls.Panel))
                foreach (Control x in y.Controls)
                {
                    ...
                    else
                    {
                        ...
                        if ((ViewState["LabPanel"] == "Additional Lab") && (x.GetType() == typeof(System.Web.UI.WebControls.CheckBox)))
                        {
    ...
    private void AddFieldAttributes(Hashtable HTUnit)
    {
        ...
        ///////// As the Boundary Ranges/Normal Ranges are bounded to the SubTest     ////////////
        ///////// Linked to the Laboratory Tests.. Filters on the Sub Test Id are used////////////
        ...
        //--txtCD4.Attributes.Add("onkeyup", "chkInteger('" + txtCD4.ClientID + "'); AddBoundary('" + txtCD4.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "','" + theDV[0]["MaxBoundaryValue"] + "')");
        //theDV.RowFilter = "SubTestName = 'CD4' and DefaultUnit=1";
        ...
        //txtCD4perc.Attributes.Add("onkeyup", "chkDecimal('" + txtCD4perc.ClientID + "');");
        //--txtCD4perc.Attributes.Add("onkeyup", "chkInteger('" + txtCD4perc.ClientID + "'); AddBoundary('" + txtCD4perc.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "','" + theDV[0]["MaxBoundaryValue"] + "')");
        //theDV.RowFilter = "SubTestName = 'CD4Percent' and DefaultUnit=1";
        ...
        //txtViralLoad.Attributes.Add("onkeyup", "chkDecimal('" + txtViralLoad.ClientID + "');");
        //--txtViralLoad.Attributes.Add("onkeyup", "chkInteger('" + txtViralLoad.ClientID + "'); AddBoundary('" + txtViralLoad.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "','" + theDV[0]["MaxBoundaryValue"] + "')");
        //txtViralLoad.Attributes.Add("onblur", "CheckValue('" + txtViralLoad.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "')");
        ...
        //--set its boundary value in database
        //txtViralLoadDet.Attributes.Add("onkeyup", "chkDecimal('" + txtViralLoadDet.ClientID + "');");
        //--txtViralLoadDet.Attributes.Add("onkeyup", "chkInteger('" + txtViralLoadDet.ClientID + "'); AddBoundary('" + txtViralLoadDet.ClientID + "','0','10000')");
        //txtViralLoadDet.Attributes.Add("onblur", "CheckValue('" + txtViralLoadDet.ClientID + "','0')");
        //theDV.RowFilter = "SubTestName = 'ViralLoad Undetectable' and DefaultUnit=1";
        ...
        //txtHCT.Attributes.Add("onkeyup", "chkDecimal('" + txtHCT.ClientID + "'); ");
        //--txtHCT.Attributes.Add("onkeyup", "chkInteger('" + txtHCT.ClientID + "'); AddBoundary('" + txtHCT.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "','" + theDV[0]["MaxBoundaryValue"] + "')");
        //txtHCT.Attributes.Add("onblur", "CheckValue('" + txtHCT.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "')");

        //theDV.RowFilter = "SubTestName = 'HCTPercent' and DefaultUnit=1";
        ...
        //txtprevLowestCD4.Attributes.Add("OnBlur", "isBetween('" + txtprevLowestCD4.ClientID + "', '" + "Lowest CD4" + "', '" + 0 + "', '" + 5000 + "')");

        //theDV.RowFilter = "SubTestID = 6";
        //txtHB.Attributes.Add("onkeyup", "chkDecimal('" + txtHB.ClientID + "');");
        ...
        //txtHB.Attributes.Add("onblur", "CheckValue('" + txtHB.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "')");

        //theDV.RowFilter = "SubTestName = 'Hct/Hb' and DefaultUnit=1";
        ...
        //txtWBC.Attributes.Add("onkeyup", "chkDecimal('" + txtWBC.ClientID + "');");
        ...
        //txtWBC.Attributes.Add("onblur", "CheckValue('" + txtWBC.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "')");

        //theDV.RowFilter = "SubTestName = 'WBC' and DefaultUnit=1";
        ...
        //txtPlatelets.Attributes.Add("onkeyup", "chkDecimal('" + txtPlatelets.ClientID + "');");
        //--txtPlatelets.Attributes.Add("onkeyup", "chkInteger('" + txtPlatelets.ClientID + "'); AddBoundary('" + txtPlatelets.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "','" + theDV[0]["MaxBoundaryValue"] + "')");

        //theDV.RowFilter = "SubTestName = 'Platelets' and DefaultUnit=1";
        ...
        //theDV.RowFilter = "SubTestID = 10";
        //txtAST.Attributes.Add("onkeyup", "chkInteger('" + txtAST.ClientID + "'); AddBoundary('" + txtAST.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "','" + theDV[0]["MaxBoundaryValue"] + "')");
        //txtAST.Attributes.Add("onkeyup", "chkDecimal('" + txtAST.ClientID + "');");
        ...
        //theDV.RowFilter = "SubTestName = 'AST' and DefaultUnit=1";
        ...
        //theDV.RowFilter = "SubTestID = 11";
        //txtALT.Attributes.Add("onkeyup", "chkInteger('" + txtALT.ClientID + "'); AddBoundary('" + txtALT.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "','" + theDV[0]["MaxBoundaryValue"] + "')");
        //txtALT.Attributes.Add("onkeyup", "chkDecimal('" + txtALT.ClientID + "');");
        ...
        //theDV.RowFilter = "SubTestName = 'ALT' and DefaultUnit=1";
        //theDV.RowFilter = "SubTestId = 11 and DefaultUnit=1";
        //if (theDV.Count != 0)
        //{
        //    txtALT.Attributes.Add("onkeyup", "chkDecimal('" + txtALT.ClientID + "'); AddBoundary('" + txtALT.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "','" + theDV[0]["MaxBoundaryValue"] + "')");
        ...
        //}
        //theDV.RowFilter = "SubTestID = 13";
        //txtAmylase.Attributes.Add("onkeyup", "chkInteger('" + txtAmylase.ClientID + "'); AddBoundary('" + txtAmylase.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "','" + theDV[0]["MaxBoundaryValue"] + "')");
        //txtAmylase.Attributes.Add("onkeyup", "chkDecimal('" + txtAmylase.ClientID + "'); ");
        ...
        //txtUrinalysis1.Attributes.Add("onkeyup", "chkDecimal('" + txtUrinalysis1.ClientID + "');");
        ...
        //theDV.RowFilter = "SubTestName = 'UrinalysisGrav' and DefaultUnit=1";
        ...
        //txtUrinalysis2.Attributes.Add("onkeyup", "chkNumeric('" + txtUrinalysis2.ClientID + "');");
        ...
        //txtUrinalysis2.Attributes.Add("onblur", "CheckValue('" + txtUrinalysis2.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "')");

        //theDV.RowFilter = "SubTestName = 'UrinalysisGlucose' and DefaultUnit=1";
        ...
        //txtUrinalysis3.Attributes.Add("onkeyup", "chkNumeric('" + txtUrinalysis3.ClientID + "');");
        ...
        //theDV.RowFilter = "SubTestName = 'UrinalysisKetone' and DefaultUnit=1";
        ...
        //txtUrinalysis4.Attributes.Add("onkeyup", "chkNumeric('" + txtUrinalysis4.ClientID + "');");
        ...
        //theDV.RowFilter = "SubTestName = 'UrinalysisProtein' and DefaultUnit=1";
        ...
        //txtUrinalysis5.Attributes.Add("onkeyup", "chkNumeric('" + txtUrinalysis5.ClientID + "');");
        ...
        //theDV.RowFilter = "SubTestName = 'UrinalysisLeuk' and DefaultUnit=1";
        ...
        //txtUrinalysis6.Attributes.Add("onkeyup", "chkNumeric('" + txtUrinalysis6.ClientID + "');");
        ...
        //theDV.RowFilter = "SubTestName = 'UrinalysisNitrate' and DefaultUnit=1";
        ...
        //txtUrinalysis7.Attributes.Add("onkeyup", "chkNumeric('" + txtUrinalysis7.ClientID + "');");
        ...
        //theDV.RowFilter = "SubTestName = 'UrinalysisBlood' and DefaultUnit=1";
        ...
        //--neut1.Attributes.Add("onkeyup", "chkInteger('" + neut1.ClientID + "'); AddBoundary('" + neut1.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "','" + theDV[0]["MaxBoundaryValue"] + "')");
        //neut1.Attributes.Add("onkeyup", "chkDecimal('" + neut1.ClientID + "');");

        //theDV.RowFilter = "SubTestName = 'DiffNeut' and DefaultUnit=1";
        ...
        //neut2.Attributes.Add("onkeyup", "chkDecimal('" + neut2.ClientID + "');");
        //--neut2.Attributes.Add("onkeyup", "chkInteger('" + neut2.ClientID + "'); AddBoundary('" + neut2.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "','" + theDV[0]["MaxBoundaryValue"] + "')");

        //theDV.RowFilter = "SubTestName = 'DiffNeutperc' and DefaultUnit=1";
        ...
        //lymph1.Attributes.Add("onkeyup", "chkDecimal('" + lymph1.ClientID + "');");
        //--lymph1.Attributes.Add("onkeyup", "chkInteger('" + lymph1.ClientID + "'); AddBoundary('" + lymph1.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "','" + theDV[0]["MaxBoundaryValue"] + "')");

        //theDV.RowFilter = "SubTestName = 'DiffLymph' and DefaultUnit=1";
        ...
        //lymph2.Attributes.Add("onkeyup", "chkDecimal('" + lymph2.ClientID + "');");
        //--lymph2.Attributes.Add("onkeyup", "chkInteger('" + lymph2.ClientID + "'); AddBoundary('" + lymph2.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "','" + theDV[0]["MaxBoundaryValue"] + "')");

        //theDV.RowFilter = "SubTestName = 'DiffLymphperc' and DefaultUnit=1";
        ...
        //mono1.Attributes.Add("onkeyup", "chkDecimal('" + mono1.ClientID + "');");
        //--mono1.Attributes.Add("onkeyup", "chkInteger('" + mono1.ClientID + "'); AddBoundary('" + mono1.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "','" + theDV[0]["MaxBoundaryValue"] + "')");

        //theDV.RowFilter = "SubTestName = 'DiffMono' and DefaultUnit=1";
        ...
        //mono2.Attributes.Add("onkeyup", "chkDecimal('" + mono2.ClientID + "');");
        //--mono2.Attributes.Add("onkeyup", "chkInteger('" + mono2.ClientID + "'); AddBoundary('" + mono2.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "','" + theDV[0]["MaxBoundaryValue"] + "')");

        //theDV.RowFilter = "SubTestName = 'DiffMonoperc' and DefaultUnit=1";
        ...
        //eosin1.Attributes.Add("onkeyup", "chkDecimal('" + eosin1.ClientID + "');");
        //--eosin1.Attributes.Add("onkeyup", "chkInteger('" + eosin1.ClientID + "'); AddBoundary('" + eosin1.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "','" + theDV[0]["MaxBoundaryValue"] + "')");

        //theDV.RowFilter = "SubTestName = 'DiffEosin' and DefaultUnit=1";
        ...
        //eosin2.Attributes.Add("onkeyup", "chkDecimal('" + eosin2.ClientID + "');");
        //--eosin2.Attributes.Add("onkeyup", "chkInteger('" + eosin2.ClientID + "'); AddBoundary('" + eosin2.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "','" + theDV[0]["MaxBoundaryValue"] + "')");

        //theDV.RowFilter = "SubTestName = 'DiffEosinperc' and DefaultUnit=1";
        ...
        //txtRBCs.Attributes.Add("onkeyup", "chkNumeric('" + txtRBCs.ClientID + "');");
        ...
        //theDV.RowFilter = "SubTestName = 'CCRbcs' and DefaultUnit=1";
        ...
        //txtWBCs.Attributes.Add("onkeyup", "chkNumeric('" + txtWBCs.ClientID + "');");
        ...
        //theDV.RowFilter = "SubTestName = 'CCWBCs' and DefaultUnit=1";
        ...
        //txtNeutrophils.Attributes.Add("onkeyup", "chkNumeric('" + txtNeutrophils.ClientID + "');");
        ...
        //theDV.RowFilter = "SubTestName = 'CCNeutrophilis' and DefaultUnit=1";
        ...
        //txtLymphocytes.Attributes.Add("onkeyup", "chkNumeric('" + txtLymphocytes.ClientID + "');");
        ...
        //theDV.RowFilter = "SubTestName = 'CCLymphocytes' and DefaultUnit=1";
        ...
        //--old
        //theDV.RowFilter = "SubTestID = 109 or SubTestID = 110";
        //txtGlucose.Attributes.Add("onkeyup", "chkNumeric('" + txtGlucose.ClientID + "')");

        //theDV.RowFilter = "SubTestID = 54";
        //txtGlucose.Attributes.Add("onkeyup", "chkDecimal('" + txtGlucose.ClientID + "');");
        ...
        //txtGlucose.Attributes.Add("onblur", "CheckValue('" + txtGlucose.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "')");

        //theDV.RowFilter = "SubTestName = 'Glucose mg' and DefaultUnit=1";
        ...
        //--old
        //theDV.RowFilter = "SubTestID = 111 or SubTestID = 112";
        //txtProtein.Attributes.Add("onkeyup", "chkNumeric('" + txtProtein.ClientID + "')");

        //theDV.RowFilter = "SubTestID = 32";
        //txtProtein.Attributes.Add("onkeyup", "chkDecimal('" + txtProtein.ClientID + "'); ");
        ...
        //txtProtein.Attributes.Add("onblur", "CheckValue('" + txtProtein.ClientID + "','" + theDV[0]["MinBoundaryValue"] + "')");

        //theDV.RowFilter = "SubTestName = 'Protein mg' and DefaultUnit=1";
    ...
    private Boolean FieldValidation()
    {
        ...
        if ((txtLabOrderedbyDate.Text.Trim() != "") && (txtlabReportedbyDate.Text.Trim() != ""))
        {
            ...
            {
                IQCareMsgBox.Show("LabOrderReportedByDate", this);
                txtLabOrderedbyDate.Focus();
                return false;
            }
        }
    ...
    private DataTable CreateStaticTable()
    {
        ...
        if (sputumafb31.Checked)
        {
         ...
         if (cblSerologyPos.Checked == true)
        {
            //Add Serology
            drLab = dtLabs.NewRow();
            drLab["LabTestID"] = 53;
        ...
        else  if (cblSerologyNeg.Checked == true)
        {
            //Add Serology
            drLab = dtLabs.NewRow();
            drLab["LabTestID"] = 53;
        ...
        //--- Rupesh 08May ---
        else if (cblPCRResultsPos.Checked == true) 
        {
            //Add PCR Results
            drLab = dtLabs.NewRow();
            drLab["LabTestID"] = 94;
    ...
    private string ShowCaution()
    {
        ...
        if ((theDV.Count > 0) && (txtALT.Text != ""))
        {
            ...
            {
                strMsg = strMsg + "ALT : " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        ...
        if ((theDV.Count > 0) && (txtAmylase.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " Amylase : " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        ...
        if ((theDV.Count > 0) && (txtAST.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " AST : " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        ...
        if ((theDV.Count > 0) && (txtCD4.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " CD4 : " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        theDV.RowFilter = "SubTestId = 2";
        ...
        if ((theDV.Count > 0) && (txtCreatinine.Text != "") && (unitsCreatinine.SelectedValue == "12"))
        {
            ...
            {
                strMsg = strMsg + " Creatinine : " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        ...
        if ((theDV.Count > 0) && (txtViralLoad.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " Viral :" + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        theDV.RowFilter = "SubTestId = 6";
        if ((theDV.Count > 0) && (txtHB.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " Hb :" + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        theDV.RowFilter = "SubTestId = 5";
        if ((theDV.Count > 0) && (txtHCT.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " HCT : " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        theDV.RowFilter = "SubTestId = 7";
        if ((theDV.Count > 0) && (txtWBC.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " WBC :" + theDV[0]["MinNormalRange"].ToString() + " and " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        theDV.RowFilter = "SubTestId = 9";
        ...
        if ((theDV.Count > 0) && (txtPlatelets.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " Platelets :" + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        ...
        if ((theDV.Count > 0) && (TxtESR.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " ESR :" + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        ...
        if ((theDV.Count > 0) && (txtRBCs.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " RBCs : " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        theDV.RowFilter = "SubTestId = 29";
        if ((theDV.Count > 0) && (txtWBCs.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " WBCs : " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        theDV.RowFilter = "SubTestId = 30";
        if ((theDV.Count > 0) && (txtNeutrophils.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " Neutrophils :" + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        theDV.RowFilter = "SubTestId = 31";
        if ((theDV.Count > 0) && (txtLymphocytes.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " Lymphocytes : " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        ...
        if ((theDV.Count > 0) && (txtProtein.Text != "") && (unitsProtein.SelectedValue == "111"))
        {
            ...
            {
                strMsg = strMsg + " Protein : " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        ...
        if ((theDV.Count > 0) && (txtGlucose.Text != "") && (unitsGlucose.SelectedValue == "109"))
        {
            ...
            {
                strMsg = strMsg + " Glucose : " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        ...
        if ((theDV.Count > 0) && (neut1.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " Diff Neut :" + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        theDV.RowFilter = "SubTestId = 83";
        ...
        if ((theDV.Count > 0) && (lymph1.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " Lymph : " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        theDV.RowFilter = "SubTestId = 85";
        ...
        if ((theDV.Count > 0) && (mono1.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " Mono : " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        theDV.RowFilter = "SubTestId = 87";
        ...
        if ((theDV.Count > 0) && (eosin1.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " Eosin : " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        theDV.RowFilter = "SubTestId = 89";
        ...
        if ((theDV.Count > 0) && (txtUrinalysis1.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " Specific Gravity : " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        theDV.RowFilter = "SubTestId = 91";
        ...
        if ((theDV.Count > 0) && (txtUrinalysis3.Text != ""))
        {
            ...
            {
                strMsg = strMsg + "Ketone : " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        theDV.RowFilter = "SubTestId = 93";
        ...
        if ((theDV.Count > 0) && (txtUrinalysis5.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " Leuk Est : " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        theDV.RowFilter = "SubTestId = 95";
        if ((theDV.Count > 0) && (txtUrinalysis6.Text != ""))
        {
            ...
            {
                strMsg = strMsg + " Nitrate : " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        theDV.RowFilter = "SubTestId = 96";
        if ((theDV.Count > 0) && (txtUrinalysis7.Text != ""))
        {
            ...
            {
                strMsg = strMsg + "Blood " + theDV[0]["MinNormalRange"].ToString() + " to " + theDV[0]["MaxNormalRange"].ToString() + "</br>";
            }
        }
        if (strMsg.Trim() != "")
        {
            strMsg = "Following tests are outside the normal range:</br>" + strMsg;
        }
        return strMsg;
    }
    ...
    private void LoadPatientLabOrder(DataSet theDS)
    {
        ...
        if (Convert.ToInt32(ViewState["LabId"]) > 0)
        {
            ...
            for (int i = 0; i < theDSDetails.Tables[0].Rows.Count; i++)
            {
                switch (theDSDetails.Tables[0].Rows[i]["SubTestId"].ToString())
                {
                    ...
                    case "1":
                        ...
                        {
                            lblCD4.Text = theDSDetails.Tables[0].Rows[i]["UnitName"].ToString();
                    ...
                    case "107":
                        if (theDSDetails.Tables[0].Rows[i]["TestResults"] != System.DBNull.Value)
                        {
                            if (Convert.ToDecimal(theDSDetails.Tables[0].Rows[i]["TestResults"]) != 0)
                            {
                                ...
                                script += "</script>\n";
                                RegisterStartupScript("VLDetectable", script);
            ...
            if (theDSDetails.Tables[0].Rows.Count > 0)
            {
    ...
    private void EnableControlDynamic()
    {
        ...
        try
        {
            ...
            if (LabID != "0")
            {
                ...
                if (theDSLabResult.Tables[1].Rows.Count == 0)
                {
                    lnkLabTest.Visible = true;
                }
                //else
                //{
                ...
                foreach (DataRow dr in theDSLabResult.Tables[0].Rows)
                {
                    ...
                    switch (LabIDLocal)
                    {
                        ...
                        case 2:
                            ...
                            break;
                        case 53:
                            Page.ClientScript.RegisterStartupScript(this.GetType(), "sp53", "document.getElementById('sp53').setAttribute('disabled', false);;", true);
                            ...
                            Page.ClientScript.RegisterStartupScript(this.GetType(), "cblSerologyPos", "document.getElementById('ctl00_IQCareContentPlaceHolder_cblSerologyPos').disabled='';", true);
                            Page.ClientScript.RegisterStartupScript(this.GetType(), "cblSerologyNeg", "document.getElementById('ctl00_IQCareContentPlaceHolder_cblSerologyNeg').disabled='';", true);
                            break;
                        case 101:
    ...
    private void VLdetectable()
    {
        ...
        script += "</script>\n";
        RegisterStartupScript("VLDetectableload", script);
    ...
    private void PutCustomControl()
    {
        ...
        //                customLabel.Text = customLabel.Text.Replace("Lab", "");
        ...
        //                theMultiSelectlbl.Text = theMultiSelectlbl.Text.Replace("Lab", "");
        ...
        //            theCustomField.CreateCustomControls(pnlCustomList, pnlName, ref sbParameter, dr, ref TableName, "Lab", ii);
    ...
    protected void Page_Load(Object sender, EventArgs e)
    {
        ...
        //(Master.FindControl("lblheader") as Label).Text = "Lab Order";
        (Master.FindControl("levelOneNavigationUserControl1").FindControl("lblRoot") as Label).Text = "Clinical Forms >> ";
        (Master.FindControl("levelOneNavigationUserControl1").FindControl("lblheader") as Label).Text = "Lab Order";
       // (Master.FindControl("levelTwoNavigationUserControl1").FindControl("lblformname") as Label).Text = "Password";
        ...
        try
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                {
                    //********************************************************
                    //Previously, system was checking the Lab Order with IE
                    //form but with the change in business rule from V1.7 it 
                    //is now taking Enrollment Date into Account
                    //********************************************************
                ...
                //IQCareUtils theUtils = new IQCareUtils();
                //DataView theDVLab =  new DataView(.Copy());
                //theDVLab.RowFilter = "LabTestId <> 74 and LabTestId <> 75";
                //DataTable theDTLab = theUtils.CreateTableFromDataView(theDVLab);
                //if (theDTLab.Rows.Count >= 1)
    ...
    private void FillUnits()
    {
        ...
        if(ViewState["HTUnitId"]!=null)
            ...
            if (lblCD4.Text == "")
            {
                ...
                lblCD4.Text = (theDV.Count != 0) ? theDV[0]["UnitName"].ToString() : "";
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        //{
        //    theUrl = string.Format("{0}?PatientId={1}&sts={2}", "../ClinicalForms/frmPatient_History.aspx", Session["PatientId"], Request.QueryString["sts"].ToString());
        //}
        //else
        //{
        //    theUrl = string.Format("{0}?PatientId={1}&sts={2}", "../ClinicalForms/frmClinical_DeleteForm.aspx", Session["PatientId"], Request.QueryString["sts"].ToString());
        //}
        ...
        if (Request.QueryString["opento"] == "ArtForm")
        {
            ...
            script += "self.close();";
            script += "</script>\n";
            RegisterStartupScript("Showclose", script);
            return;
        }
        Response.Redirect(theUrl);
    }
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (msg.Length > 45)
            {
                ...
                script += "</script>\n";
                RegisterStartupScript("ShowCaution", script);
                return;
            }
            else
            {
    ...
    //protected void unitsGlucose_SelectedIndexChanged(object sender, EventArgs e)
    //{
    ...
    //    //theDV.RowFilter = "LabTestID = 54";

    //    //if (Convert.ToInt32(this.txtGlucose.Text) < Convert.ToInt32(theDV[0]["MinBoundaryValue"].ToString()))
    //    //{
    //    //    this.txtGlucose.Text = "";
    //    //    this.txtGlucose.Focus();
    //    //}

    //    //if (Convert.ToInt32(this.txtGlucose.Text) > Convert.ToInt32(theDV[0]["MaxBoundaryValue"].ToString()))
    //    //{
    //    //    this.txtGlucose.Text = "";
    //    //    this.txtGlucose.Focus();
    //    //}
    ...
    //protected void UnitsProtein_SelectedIndexChanged(object sender, EventArgs e)
    //{
    //    /*
    //    ILabFunctions LabMaster;
    //    LabMaster = (ILabFunctions)ObjectFactory.CreateInstance("BusinessProcess.Laboratory.BLabFunctions, BusinessProcess.Laboratory");
    ...
    //    theDV.RowFilter = "LabTestID = 32";
    //    if (this.txtProtein.Text.Trim() != "")
    //    {
    //        if (Convert.ToInt32(this.txtProtein.Text) < Convert.ToInt32(theDV[0]["MinBoundaryValue"]))
    //        {
    //            this.txtProtein.Text = "";
    //            this.txtProtein.Focus();
    //        }
    //        if (Convert.ToInt32(this.txtProtein.Text) > Convert.ToInt32(theDV[0]["MaxBoundaryValue"]))
    //        {
    //            this.txtProtein.Text = "";
    //            this.txtProtein.Focus();
    //        }
    ...
    protected void lnkLabTest_Click(object sender, EventArgs e)
    {
       ...
       // theOrdScript += "window.open('frmLabOrderTests.aspx?Mode=Edit&LabID=" + ViewState["LabId"] + "&sts="+ Convert.ToString(Request.QueryString["sts"])+"','LabSelection','toolbars=no,location=no,directories=no,dependent=yes,top=100,left=30,maximize=no,resize=no,width=1000,height=500,scrollbars=yes');\n";
        ...
        theOrdScript += "</script>\n";
        RegisterStartupScript("LabOrderPopup", theOrdScript);
