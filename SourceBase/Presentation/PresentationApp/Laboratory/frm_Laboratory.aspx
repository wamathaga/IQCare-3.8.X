                        ...
                        <tbody>
                            <tr>
                                <td class="form" align="center" valign="middle" width="50%">
                                    <label>
                                        Preclinic Labs:</label><asp:CheckBox ID="preclinicLabs" runat="server" Style="vertical-align: bottom;
                            ...
                            <tr id="btntr" runat="server">
                                <td class="pad5 center" colspan="2">
                                    ...
                                    <asp:Button ID="btnsave" runat="server"  Width="8%" Text="Save" OnClick="BtnSaveClick"
                                    ...
                                    <asp:Button ID="btnclose" runat="server"  Width="8%" Text="Close"
                                        OnClick="btnclose_Click" CssClass="btn btn-primary" Height="30px" Style="text-align: left;" />
