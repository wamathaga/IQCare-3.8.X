...
<asp:Content ID="Content1" ContentPlaceHolderID="IQCareContentPlaceHolder" runat="Server">
    ...
    <div class="container-fluid">
        <h5 class="nomargin h5" id="tHeading" runat="server">
            Find/Add Patient</h5>
            ...
            <asp:UpdatePanel ID="up_patient" runat="server">
                <ContentTemplate>
                    ...
                    <table align="center" width="100%" border="1" class="table-condensed">
                        <tr>
                            <td class="border pad5 whitebg" valign="top" width="47%" align="left">
                            ...
                            <td class="border pad5 whitebg" valign="top" width="23%" align="left">
                                <table width="100%" border="0">
                                    <tr>
                            ...
                            <td id="tdPatientOtherDetails" class="border pad5 whitebg" runat="server" align="left"
                                valign="top">
                                <table width="100%" border="0">
                                    <tr>
                                        <td style="white-space: nowrap; width: 50%">
                    ...
                    <!-- End Stacey's code -->
                    <table class="center table-condensed" width="100%">
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" Text="Add Patient"
                                                    CssClass="btn btn-primary" Height="30px" Width="89%" Style="text-align: left;
                                                    margin-left: 10%;" /><span id="spanBtnAdd" runat="server" class="glyphicon glyphicon-plus"
                                                        style="margin-left: -11%; vertical-align: middle; color: #fff; margin-top: 3%;"></span>
                                            </td>
                                            <td style="padding-left: 5px;">
                                                <asp:Button ID="btnCancel" runat="server" OnClick="btnCancel_Click" Text="Back" CssClass="btn btn-primary"
                                                    Height="30px" Width="88%" Style="text-align: left;" />
                                                <span class="glyphicon glyphicon-backward" style="margin-left: -27%; vertical-align: middle;
