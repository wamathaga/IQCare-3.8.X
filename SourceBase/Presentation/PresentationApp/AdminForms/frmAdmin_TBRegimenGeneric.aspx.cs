...
public partial class AdminForms_frmAdmin_TBRegimenGeneric : LogPage
{
    ...
    private Boolean FieldValidation()
    {
        ...
        //ds = DrugManager.GetTBRegimenName(strRegimenName.Trim());
        ...
        //}
         ...
         //if (strStatus == "1")
         //{
         //    IQCareMsgBox.Show("In-Active TB Regimen can not be updated", this);
         //    return false;
         //}
        return true;
    }
