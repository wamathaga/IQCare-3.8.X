...
public partial class frmAdmin_Drug : LogPage
{
    ...
    private Boolean FieldValidation()
    {
        ...
        if ((txtDrugName.Text == "") && (Convert.ToInt32(ddDrugTypeID.SelectedValue) == 37)) 
        {
            ...
            //{
            //    GenID = Convert.ToInt32(theDR[0]);
            //    //Int32 GenID=Convert.ToInt32(((DataTable)ViewState["SelGeneric"]).Rows[0][0].ToString());
            //    DataTable theDT = (DataTable)DrugManager.GetStrengthByGenericID(GenID);
            //    if (theDT.Rows.Count == 0)
            //    {
            //        IQCareMsgBox.Show("NoDoseFrq", this);
            //        return false;
            //    }
            //}
        ...
        //if ((txtDrugAbbre.Text.Trim() == "") && (Convert.ToInt32(ddDrugTypeID.SelectedValue) == 37))
        //{
        //    theBuilder.DataElements["Control"] = "Drug Abbrevation";
        //    EventArgs e = new EventArgs();
        //    ddDrugType_SelectedIndexChanged(btnSave, e);
        //    IQCareMsgBox.Show("BlankTextBox", theBuilder, this);
        //    txtDrugAbbre.Focus();
        ...
        //if (Convert.ToInt32(ddDrugTypeID.SelectedValue)  == 37)
        //{
            //if (lstFrequency.Items.Count == 0)
            //{
        ...
        //    if (lstGeneric.Items.Count > 1)
        //    {
        //        IQCareMsgBox.Show("FixedDose", this);
        //        return false;
        //    }
        ...
        if (Page.IsPostBack != true)
        {
            ...
            else if (Request.QueryString["name"] == "Edit")
            {
                ...
                if (theExistDS.Tables.Count != 0)
                {
                    ...
                    //    }
                    //    lstStrength.Visible = false;
                    //    lstFrequency.Visible = false;
                    //    btnAddDose.Visible = false;
                    //    btnAddFrequency.Visible = false;
                    //}
                    if (DrugTypeId == 60)
                    {
                        vaccshow.Visible = true;
    ...
    private void GetMasters()
    {
        ...
        try
        {
            ...
            /* 06Feb08 - implementing XML
            DrugManager = (IDrugMst)ObjectFactory.CreateInstance("BusinessProcess.Administration.BDrugMst, BusinessProcess.Administration");
            DataSet theDS = (DataSet)DrugManager.GetAllDropDowns();//pr_Admin_GetDrugDropDowns_Constella 
            theMasterDS.Tables.Add(theDS.Tables[0].Copy());//pr_Admin_SelectAllGenericsList_Constella
            //----Rupesh 13Dec07-----
            //theMasterDS.Tables.Add(theDS.Tables[1].Copy());
            if(Request.QueryString["Status"]==null) // incase of add 
                theMasterDS.Tables.Add(theDS.Tables[5].Copy());//get only active generics
            else if (Request.QueryString["Status"].ToString() == "InActive")
                theMasterDS.Tables.Add(theDS.Tables[1].Copy()); // get list of all generics
            else if(Request.QueryString["Status"].ToString() == "Active")
                theMasterDS.Tables.Add(theDS.Tables[5].Copy()); // get only active generics
            //-----------------------
            theMasterDS.Tables.Add(theDS.Tables[3].Copy());
            theMasterDS.Tables.Add(theDS.Tables[4].Copy());
            */
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //txtDrugName.Attributes.Add("onBlur", "JavaScript:EnabDisabButton('" + QueryString + "');");
        //try
        //{
            ...
            else
            {
                ...
                if ((Session["SelectedData"] != null) &&(Session["SelectedData"] != ""))
                {
                    string theDrugType = "";
                ...
                if ((Session["SelectedScheduleData"] != null) && (Session["SelectedScheduleData"] != ""))
                {
                    string theDrugType = "";
                    if(Session["Type"]!=null)
                        theDrugType = Session["Type"].ToString();
            ...
            //if((Request.QueryString["name"] == "Add") && (ddDrugTypeID.SelectedValue == "37"))
            {
                ...
                if (ddDrugTypeID.SelectedValue == "60")
                {
                    ...
                    vaccshow.Visible = true;
                    arvShow1.Visible = false;
                    //FrequencyID.Controls.Remove(arvShow1);
                    //FrequencyID.Controls.Add(vaccshow);
                }
                else
                {
                ...
                theScript += "</script>\n";
                Page.RegisterClientScriptBlock("ShowChange", theScript);
            }
    ...
    protected void ddDrugType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        //#region "Hide/Unhide"
        //string theScript = "<script language='javascript' defer = 'defer' id='ShowChange'>\n";
        //if (ddDrugTypeID.SelectedValue != "37" && ddDrugTypeID.SelectedValue != "60")
        //{
        //    theScript += "show('" + arvShow.ClientID + "'); show('" + arvShow1.ClientID + "');\n";
        //}
        //else if (ddDrugTypeID.SelectedValue == "60")
        //{
        //    theScript += "show('" + vaccshow.ClientID + "');\n";
        //}
        ////else
        ////{
        ////    theScript += "show('" + nonARVShow1.ClientID + "');\n";
        ////}
        //theScript += "</script>\n";
        //Page.RegisterClientScriptBlock("ShowChange", theScript);
    ...
    protected void btnAddDose_Click(object sender, EventArgs e)
    {
        if (lstGeneric.Items.Count > 0)
        {
            ...
            theScript += "</script>\n";
            Page.RegisterClientScriptBlock("DrgStrength", theScript);
            ddDrugType_SelectedIndexChanged(sender, e);
            #region "Display Controls"
            theScript = "";
    ...
    protected void btnAddFrequency_Click(object sender, EventArgs e)
    {
        if (lstGeneric.Items.Count > 0)
        {
            ...
            theScript += "</script>\n";
            Page.RegisterClientScriptBlock("DrgFrequency", theScript);
            ddDrugType_SelectedIndexChanged(sender, e);
            #region "Display Controls"
            theScript = "";
            theScript = "<script language='javascript' defer = 'defer' id='ShowStatus'>\n";
    ...
    protected void btnAddGeneric_Click(object sender, EventArgs e)
    {
        ...
        if (txtDrugName.Text != "")
        {
            //ViewState["SelGeneric"] = null; // rupesh 16-07-07
            //ViewState["GenericMaster"] = ViewState["GenericMasterFD"];
        }
    ...
    protected void RefreshCache()
    {
        ...
        //script += "var ans=true;\n";
        script += "NotifyMessage('Please refresh cache');\n";
        //script += "if (ans==true)\n";
        //script += "{\n";
    ...
    private void Backup()
    {
        ...
        //        <table>
        //        <tr>
        //        <td class="border center pad5 whitebg" width="100%" colspan="2" style="visibility:hidden">
        //                <div id="nonARVShow1"  runat = "server"   style="visibility:hidden">
        //                 <%--<LABEL class=Center>Dose Boundary Values: Maximum </LABEL>--%>
        //                 <label class="margin">Dose Boundary Values:  </label>&nbsp&nbsp
        //                <label class="Center"> Minimum </label>

        //             <asp:TextBox ID="minDosetxt" MaxLength= "4"  runat="server"></asp:TextBox>

        //                <label class="Center"> Maximum </label>
        //                <asp:TextBox ID="maxDosetxt" MaxLength="4"   runat="server"></asp:TextBox>
        //                </div>
        //        </td>
        //             </tr>
        //        </table>
        ...
        //        <label class="Center">Available Doses  </label><br />
        //        <asp:ListBox ID="lstStrength"  runat="server" Height = "90px" Width="300px"></asp:ListBox><br />
        //        <asp:Button ID="btnAddDose" runat="server" Text="Add Doses" OnClick="btnAddDose_Click"/>
        //    </div>
        //    </td>
        //     <td id="FrequencyID"   class="border center pad5 whitebg"  style="width: 50%">
        //    <div id="arvShow1"  runat = "server" style="display:none" > 
        //        <label  class="center">Available Frequency</label><br />
        //        <asp:ListBox ID="lstFrequency"  runat="server" Height = "90px" Width="300px"></asp:ListBox><br />
        //        <asp:Button ID="btnAddFrequency" runat="server" Text="Add Frequency" OnClick="btnAddFrequency_Click"/>
        //    </div> 
        //    </td> 
        //</tr> 
         ...
         * make nonARV generic - d
         * make nonARV drug - d
         * make nonARV fixed drug - d - not possible
         * make arvGeneric - d
         * make arv drug-d
         * make arv Fixed drug-d
        Edit
            
         * edit ARV Generic - d
         * edit non-ARV Generic- d -actually its not possible
         * edit ARV Trade -d
         * edit non-ARV Trade
         */
    }
    protected void btnAddshedule_Click(object sender, EventArgs e)
    {
        ...
        //{
            ...
            theScript += "</script>\n";
            Page.RegisterClientScriptBlock("DrgSchedule", theScript);
            ddDrugType_SelectedIndexChanged(sender, e);
            #region "Display Controls"
            theScript = "";
            theScript = "<script language='javascript' defer = 'defer' id='ShowStatus'>\n";
