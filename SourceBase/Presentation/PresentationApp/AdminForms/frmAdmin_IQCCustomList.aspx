<%@ Page Language="C#" MasterPageFile="~/MasterPage/IQCare.master" AutoEventWireup="True"
    Inherits="frmAdmin_CTCCustomList" CodeBehind="frmAdmin_IQCCustomList.aspx.cs" %>
                                                ...
                                                <div class="mid" style="height: 300px; overflow: auto">
                                                    <div id="grd_custom" class="GridView whitebg">
                                                        <asp:GridView ID="grdCustom" runat="server" AutoGenerateColumns="False" AllowSorting="true"
                                                            ...
                                                            CssClass="datatable" CellPadding="0" CellSpacing="0" OnSelectedIndexChanging="grdCustom_SelectedIndexChanging"
