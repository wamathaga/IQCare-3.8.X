...
<asp:Content ID="Content1" ContentPlaceHolderID="IQCareContentPlaceHolder" runat="Server">
    <div class="container-fluid">
        <h5 class="h5">
            Configure Custom Form Fields</h5>
                                ...
                                <tr>
                                    <td class="border pad5 whitebg" valign="top" width="50%">
                                        <label class="margin20" style="vertical-align: top;">
                                            Field Label:</label><asp:TextBox ID="txtflabel" CssClass="pad5" runat="server" Width="300px"
                                                MaxLength="90"></asp:TextBox><br />
                                        <br />
                                        <label class="margin20" style="vertical-align: top;">
                                            Field Descr:</label><asp:TextBox ID="txtfdesc" runat="server" TextMode="MultiLine"
                                                MaxLength="250" Width="300px" CssClass="MultiLineTextBox"></asp:TextBox><br />
                                        <br />
                                    </td>
                                </tr>
                                <tr>
                                                ...
                                                <div class="mid" style="cursor: pointer; height: 280px; overflow: auto;">
                                                    <div id="div-gridview" class="gridview whitebg">
                                                        <asp:GridView ID="grdCustomfields" runat="server" AllowSorting="true" OnRowDataBound="grdCustomfields_RowDataBound"
                                                            DataKeyNames="CustomFieldID" AutoGenerateColumns="False" Width="100%" CssClass="datatable"
