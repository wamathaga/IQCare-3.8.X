...
public partial class frmAdmin_UserList : LogPage
{
    /////////////////////////////////////////////////////////////////////
    ...
    private void BindGrid()
    {
        ...
        theCol6.HeaderText = "Employee Designation";
        theCol6.DataField = "Designation";
        theCol6.SortExpression = "Designation";
    ...
    protected void GrdUserList_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        ...
        if (theRow.Cells[4].Text.ToString() != "InActive")
        {
            int UserId = Convert.ToInt32(theRow.Cells[5].Text.ToString());
