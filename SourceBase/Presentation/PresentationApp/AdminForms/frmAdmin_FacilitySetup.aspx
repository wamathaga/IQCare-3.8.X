...
<asp:Content ID="Content1" ContentPlaceHolderID="IQCareContentPlaceHolder" runat="Server">
    <%--  <form id="facilitysetup" method="post" runat="server" enableviewstate="true">--%>
    <div class="container-fluid">
        <h4 class="h4">
            <asp:Label ID="lblForm" runat="server" Text="a"></asp:Label></h4>
        <div class="border center formbg" style="padding: 5px;">
            <%--<div class="border center formbg">--%>
            <table class="pad5 formbg" width="100%" class="table-condensed">
                <tr>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    ...
                                    <img onclick="w_displayDatePicker('<%= txtPEPFAR_Fund.ClientID %>');" height="22"
                                        ...
                                        style="vertical-align: sub;"><span class="smallerlabel">(DD-MMM-YYYY)</span>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td class="border pad5 whitebg" valign="top" width="50%">
                        <table width="100%">
                            <tr>
                                <td align="right" style="width: 50%">
                                    <label style="width: 100%" align="right">
                ...
                <tr>
                    <td class="border pad5 whitebg" valign="top" align="center" width="50%">
                        <table>
                            <tr>
                ...
                <tr>
                    <td class="border center whitebg" colspan="2">
                        <table width="100%">
                            <tr>
                                <td class="pad35">
                                    <div class="whitebg" id="div3" runat="server">
                                        <label class="center">
                                            Drug Stores:
                                        </label>
                                    </div>
                                    <div nowrap='nowrap' class="divBorder border left whitebg" align="left" id="divDrugStore"
                                        runat="server" width="1%" style="cursor: pointer; height: 120px; overflow: auto;">
