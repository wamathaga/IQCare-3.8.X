...
public partial class CustomFields_frmConfig_Customfields : LogPage, ICallbackEventHandler
{
    ...
    protected void FillDropDownFeatures()
    {
        ...
        try
        {
            ...
            theDV.RowFilter = "FeatureId not IN(3,5)";
            BindFunctions BindManager = new BindFunctions();
            BindManager.BindCheckedList(Chkformname, theDV.ToTable(), "FeatureName", "FeatureID");
        }
        catch (Exception err)
        {
            MsgBuilder theBuilder = new MsgBuilder();
    ...
    private void FormPopulate(int fID, int CID, int CustFieldID)
    {
        ...
        switch (CID)
        {
            case 8:
                ...
                thescript += "</script>\n";
                RegisterClientScriptBlock("CT", thescript);
    ...
    private void BindGrid()
    {
        ...
        theCol2.HeaderText = "Description";
        theCol2.DataField = "FieldDesc";
        //theCol2.SortExpression = "FieldDesc";
        theCol2.ItemStyle.CssClass = "aw-grid-control";
        ...
        */
        ...
        theCol4.HeaderText = "ControlID";
        theCol4.ItemStyle.CssClass = "textstyle";
        theCol4.DataField = "ControlID";
        ...
        */
        ...
        theBtn1.ControlStyle.CssClass = "btn btn-info";
        theBtn1.ControlStyle.Height = 30;
        ...
        //ButtonField theBtn3 = new ButtonField();
        //theBtn3.ButtonType = ButtonType.Button;
        //theBtn3.Text = "Reactivate";
        //theBtn3.CommandName = "Reactivate";
        //theBtn3.HeaderStyle.Width = 30;


        //theBtn2.HeaderStyle.CssClass = "textstylehidden";
        //theBtn2.ItemStyle.CssClass = "textstylehidden";
