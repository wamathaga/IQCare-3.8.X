                ...
                <tbody>
                    ...
                    <tr>
                        <td class="form" align="center" colspan="2">
                            ...
                            <%--<asp:GridView ID="GrdViewlistIE" Width=100% AutoGenerateColumns="False" runat="server" BorderColor="#666999" CellPadding="1" CellSpacing="1"  OnRowDataBound="ItemDataBoundEventHandler1">
