...
public partial class frmClinical_PatientRecordCTC : BasePage
{
    ...
    private void Show_Hide()
    {
        if (ddlARVStatus.SelectedValue == "2")
        {
            ...
            RegisterStartupScript("onstartARV", scriptdisclosure);
        ...
        try
        {
            ...
            if (Request.QueryString["name"] == "Delete")
            {
                ...
                if (Authentiaction.HasFunctionRight(ApplicationAccess.PatientRecord, FunctionAccess.View, (DataTable)Session["UserRight"]) == false)
                {
                    ...
                    string theUrl = "";
                    theUrl = string.Format("{0}?sts={1}", "../ClinicalForms/frmClinical_DeleteForm.aspx", Request.QueryString["sts"].ToString());
            ...
            if (Request.QueryString["name"] == "Edit")
            {
                ...
                if (Authentiaction.HasFunctionRight(ApplicationAccess.PatientRecord, FunctionAccess.View, (DataTable)Session["UserRight"]) == false)
                {
                    int PatientID = Convert.ToInt32(Session["PatientId"]);
                    string theUrl = "";
                    theUrl = string.Format("{0}?sts={1}", "../ClinicalForms/frmPatient_History.aspx", Request.QueryString["sts"].ToString());
                    Response.Redirect(theUrl);
                }
    ...
    public string GetHeightCD4Regimen(string strVisitDate)
    {
        ...
        string Ptn_Pk = Session["Ptn_Pk"].ToString();
        string VisitId = Session["VisitId"].ToString();
        string LocationID = Session["AppLocationID"].ToString();
        ...
        objDs = PatientManager.GetHeightCD4Regimen(Ptn_Pk, VisitId, strVisitDate, LocationID);//pr_Clinical_GetHeightCD4RegimenCTC_Constella
        ...
        if (objDs.Tables[1].Rows.Count > 0)
        {
            ...
            PrevMostRecentCD4Date = Convert.ToDateTime(objDs.Tables[1].Rows[0]["PrevMostRecentCD4Date"]).ToString(Session["AppDateFormat"].ToString()).ToString();
        }
        else
        {
            PrevMostRecentCD4 = "";
        ...
        if (objDs.Tables[2].Rows.Count > 0)
        {
            ...
            RegimenDate = Convert.ToDateTime(objDs.Tables[2].Rows[0]["RegimenDate"]).ToString(Session["AppDateFormat"].ToString()).ToString();
        }
        else
        {
            RegimenName = "";
    ...
    protected void ShowData()
    {
        ...
        int Ptn_Pk = Convert.ToInt32(Session["PatientId"]);
        ...
        if (Mode == "Edit" || Mode == "Delete")
        {
            ...
            if (theDS.Tables[3].Rows[0]["Pregnant"] != System.DBNull.Value)
            {
                ...
                else if (Convert.ToInt32(theDS.Tables[3].Rows[0]["Pregnant"]) == 1)
                {
                    ...
                    //////script += "</script>\n";
                    //////RegisterStartupScript("rdopreg", script);
    ...
    private void DeleteForm()
    {
        ...
        PatientManager = (IPatientRecord)ObjectFactory.CreateInstance("BusinessProcess.Clinical.BPatientRecord, BusinessProcess.Clinical");
        theResultRow = PatientManager.DeletePatientRecord(FormName, OrderNo, Convert.ToInt32(Session["PatientId"]), Convert.ToInt32(Session["AppUserId"]));
    ...
    protected Boolean Validation()
    {
        ...
        theDS = PatientManager.CheckVisitDate(Session["PatientId"].ToString(), Convert.ToInt32(Session["AppLocationID"]), theVisitDate, VisitId);
    ...
    private void MakeHTandSave()
    {
        ...
        ht.Add("Ptn_Pk", Convert.ToInt32(Session["PatientId"]));
    ...
    private void SaveCancel()
    {
        ...
        if (Request.QueryString["name"] == "Add")
            ...
            script += "window.location.href='../ClinicalForms/frmPatient_History.aspx?sts=" + Request.QueryString["sts"] + "';\n";
        script += "}\n";
        script += "else \n";
        script += "{\n";
        script += "window.location.href='frmClinical_PatientRecordCTC.aspx?name=Edit&sts=" + 0 + "&visitid=" + ViewState["VisitId"].ToString() + "';\n";
        script += "}\n";
        script += "</script>\n";
    ...
    protected void btnCD4TLC_OnClick(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Session["htCD4TLC"].ToString() == "")
            {
                ...
                htCD4TLC.Add("Ptn_Pk", Convert.ToInt32(Session["PatientId"]));
            ...
            if (ddlWhyEligible.SelectedItem.ToString() == "CD4 count/%" || ddlWhyEligible.SelectedItem.ToString() == "TLC - Total Lymphocyte Count")
            {
                ...
                theScript += "</script>\n";
                Page.RegisterStartupScript("PatRecord", theScript);
            }
        }
        catch (Exception err)
        {
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if ((Master.FindControl("levelTwoNavigationUserControl1").FindControl("lblpntStatus") as Label).Text == "1")
            {
                ...
                {
                    string theUrl;
                    theUrl = string.Format("{0}?sts={1}", "frmPatient_History.aspx",  Request.QueryString["sts"].ToString());
                    Response.Redirect(theUrl);
                }
                else
                {
    ...
    private string DQ_Msg()
    {
        ...
        if (txtvisitDate.Value == "")
        {
            ...
            script += "</script>\n";
            RegisterStartupScript("VisitDate", script);
            MsgBuilder theBuilder = new MsgBuilder();
        ...
        if (txtWeight.Value == "")
        {
            ...
            script += "</script>\n";
            RegisterStartupScript("Weight", script);
            MsgBuilder theBuilder = new MsgBuilder();
        ...
        if (ddlWHOStage.SelectedValue.ToString() == "0")
        {
            ...
            script += "</script>\n";
            RegisterStartupScript("WHOStage", script);
            MsgBuilder theBuilder = new MsgBuilder();
        ...
        if (ddlFuncStatus.SelectedValue.ToString() == "0")
        {
            ...
            script += "</script>\n";
            RegisterStartupScript("FuncStatus", script);
            MsgBuilder theBuilder = new MsgBuilder();
        ...
        if (ddlTBStatus.SelectedValue.ToString() == "0")
        {
            ...
            script += "</script>\n";
            RegisterStartupScript("TBStatus", script);
            MsgBuilder theBuilder = new MsgBuilder();
        ...
        if (ddlARVStatus.SelectedValue.ToString() == "0")
        {
            ...
            script += "</script>\n";
            RegisterStartupScript("ARVStatus", script);
            MsgBuilder theBuilder = new MsgBuilder();
        ...
        if (ddlARVStatus.SelectedValue.ToString() == "1" && ddlARVReason.SelectedValue.ToString() == "0")
        {
            ...
            script += "</script>\n";
            RegisterStartupScript("ARVReason", script);
            MsgBuilder theBuilder = new MsgBuilder();
    ...
    protected void btnClose_Click(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["name"] == "Add")
            ...
            theUrl = string.Format("{0}?sts={1}", "../ClinicalForms/frmPatient_History.aspx",  Request.QueryString["sts"]);
