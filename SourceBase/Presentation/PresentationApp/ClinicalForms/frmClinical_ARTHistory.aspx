                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 30%" align="left">
                                        ...
                                        <asp:TextBox ID="txtLastUsed" runat="server" Width="25%" MaxLength="11" onblur="DateFormat(this,this.value,event,false,'3')"
                                onkeyup="DateFormat(this,this.value,event,false,'3')" onfocus="javascript:vDateType='3'"></asp:TextBox>
                                        <img onclick="w_displayDatePicker('<%= txtLastUsed.ClientID %>');" height="22" alt="Date Helper"
                                            hspace="3" src="../images/cal_icon.gif" width="22" border="0" id="Img1" style="vertical-align: bottom;" />
