...
public partial class ClinicalForms_frmClinical_ARTCare : LogPage
{
    ...
    private void SaveCancel()
    {
        ...
        IQCareMsgBox.NotifyAction("ART Care Form saved successfully. Do you want to close?", "ART Care Form", false, this, "window.location.href='frmPatient_History.aspx?sts=" + 0 + "';");
