<%@ Page Language="C#" MasterPageFile="~/MasterPage/IQCare.master" AutoEventWireup="true"
    Inherits="frmClinical_CustomForm" Title="Untitled Page" MaintainScrollPositionOnPostback="true"
...
<asp:Content ID="Content1" ContentPlaceHolderID="IQCareContentPlaceHolder" runat="Server">
    ...
    <%--</head>--%>
    <div class="container-fluid" style="padding-top: 1px; padding-left: 10px; padding-right: 10px; padding-bottom: 10px">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function OpenDynamicForm(FeatureId, PatientId) {
                //                alert(FeatureId);
                //                alert(PatientId);
                window.open('frmClinical_PopupCustomForm.aspx?FeatureId=' + FeatureId + '&PatientId=' + PatientId + '');
            }
            ...
            function EnableControlFalse(theID) {
                ...
                try {
                    ...
                    if (theID.indexOf("TXTDT") > 0) {
                        var repID = theID.replace("TXTDT", "imgTXTDT");
                        ShowHide(repID, "hide");
                    }
        ...
        <div id="DIVCustomForm" runat="server" class="container-fluid">
            <%--        <asp:ImageButton ID="IGButton" runat="server"  />--%>
            <h5 class="margin" id="Header" runat="server" visible="false">
            </h5>
            <div id="DivVisitDate" class="border center formbg" runat="server">
                <table id="tbl1" width="100%" runat="server" class="table-condensed">
                    <tbody>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="form" align="center">
                                ...
                                Height="30px" Width="8%" style="text-align:left" /><label id="lblSave" runat = "server" class="glyphicon glyphicon-floppy-disk" style="margin-left: -2.5%; 
                                vertical-align: sub; color: #fff; margin-right:2%; visibility:hidden;"></label>
                                
                                <asp:Button ID="btncomplete" runat="server" Visible="false" Text="Data Quality Check" CssClass= "btn btn-primary" Height="30px"
                                 Width="18%" OnClick="btncomplete_Click" style="text-align:left" /><label id="lblComplete" runat = "server" class="glyphicon glyphicon-floppy-saved" 
                                 style="margin-left: -2.5%; vertical-align: sub; visibility:hidden; color: #fff; margin-right:2%;"></label>
                                
                                <asp:Button ID="btnCancel" Text="Close" runat="server" OnClick="btnCancel_Click" CssClass= "btn btn-primary" Height="30px"
                                width="8%" style="text-align:left"/><label class="glyphicon glyphicon-remove-circle" style="margin-left:-2.5%; vertical-align: sub; 
                                color: #fff; margin-right:2%;"></label>
                                
                                <asp:Button ID="btnPrint" Text="Print All" Visible="false" runat="server" OnClientClick="WindowPrintAll()" CssClass= "btn btn-primary"
                                Height="30px" Width="10%" style="text-align:left"/><label id="lblPrintAll" runat = "server" class="glyphicon glyphicon-print" style="margin-left: -2.5%; 
                                visibility:hidden; vertical-align: sub; color: #fff;"></label>
                            </td>
                        </tr>
