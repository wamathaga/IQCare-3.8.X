                            ...
                            <tr>
                                ...
                                <td style="width: 35%" align="center" nowrap="nowrap">
                                    ...
                                    <img id="Img2" onclick="w_displayDatePicker('<%=txtPMTCTStartDate.ClientID%>');"
                                        ...
                                        border="0" name="appDateimg" style="vertical-align: bottom; margin-bottom: 2px;"/>
                            ...
                            <tr>
                                <td style="width: 42%"; align="right" nowrap="nowrap">
                                    ...
                                    <img id="Img7"  
                                        ...
                                        border="0" name="appDateimg" visible="true" style="visibility:hidden; vertical-align: bottom; margin-bottom: 2px;"/>
                                        <span class="smallerlabel" id="Span7" style="visibility:hidden;">(DD-MMM-YYYY)</span>
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap" align="left">
                                    ...
                                    <img id="appDateimg2" onclick="w_displayDatePicker('<%=txtDateAllergy.ClientID%>');"
                                        height="22" alt="Date Helper" hspace="5" src="../images/cal_icon.gif" width="22"
                                        border="0" name="appDateimg" style="vertical-align: bottom; margin-bottom: 2px;" /><span class="smallerlabel" id="appDatespan2">(DD-MMM-YYYY)</span>
                                </td>
                            </tr>
                        </table>
                    </td>
