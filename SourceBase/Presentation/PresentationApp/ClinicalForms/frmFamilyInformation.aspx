...
<asp:Content ID="content1" ContentPlaceHolderID="IQCareContentPlaceHolder" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div id="DivPMTCT" runat="server" class="center">
                        ...
                        <tr>
                            <td class="border pad5 whitebg" width="50%">
                                ...
                                <asp:DropDownList ID="regthisclinic" name="regthisclinic" AutoPostBack="true" runat="server"
                                    Width="11%" OnSelectedIndexChanged="regthisclinic_SelectedIndexChanged">
                                    <asp:ListItem Text="No" Value="0"></asp:ListItem>
                                    <asp:ListItem Text="Yes" Value="1"></asp:ListItem>
                                </asp:DropDownList>
                                <asp:Button ID="btnfind" Text="Find Patient" runat="server" Width="25%" OnClick="btnFind"
                                                    ...
                                                    <div class="mid" style="height: 300px; overflow: auto">
                                                        <div id="div-gridview" class="GridView whitebg">
                                                            <asp:GridView ID="grdFamily" runat="server" OnRowDataBound="grdFamily_RowDataBound"
                                                                ...
                                                                GridLines="None" CssClass="datatable" CellPadding="0" CellSpacing="0" OnSelectedIndexChanging="grdFamily_SelectedIndexChanging"
