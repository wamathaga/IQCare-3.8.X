...
public partial class ClinicalForms_frmClinical_Enrolment : BasePage
{
    ...
    private void BindDropdown(String EmployeeId)
    {
        ...
        if (theDS.Tables["Mst_Employee"] != null)
        {
            ...
            if (theDV.Table != null)
            {
                ...
                BindUserDropdown(lstenrollmentInterviewerName, string.Empty);
            }
        }
    ...
    private void Show_Hide()
    {
        ...
        if (PatientRefID == 61)
        {
            ...
            script1 += "show('lptf'); \n";
            script1 += "</script>\n";
            RegisterStartupScript("afterfunction9", script1);
        }
    ...
    private void LoadPatientData()
    {
        ...
        if (Convert.ToInt32(ViewState["visitPk"]) > 0)
        {
            ...
            if (theDS.Tables[5].Rows.Count > 0)
            {
                if (theDS.Tables[5].Rows[0]["SupportGroup"] != System.DBNull.Value)
                {
                    ...
                    else if (Convert.ToInt32(theDS.Tables[5].Rows[0]["SupportGroup"]) == 1)
                    {
                        ...
                        scriptSG += "</script>\n";
                        RegisterStartupScript("SupportGroup", scriptSG);
                    }
                }
            ...
            RegisterStartupScript("strHIVStatusChild_ID", strHIVStatusChild);
            // }
            ...
            if (theDS.Tables[3].Rows.Count > 0)
            {
                if (theDS.Tables[3].Rows[0]["PrevART"] != System.DBNull.Value)
                {
                    if (Convert.ToInt32(theDS.Tables[3].Rows[0]["PrevART"]) == 1)
                    {
                                    ...
                                    foreach (Control ct in c.Controls)
                                    {
                                        ...
                                        else if (ct.GetType() == typeof(System.Web.UI.HtmlControls.HtmlInputText))
                                        {
                                            if (OtherSponsor_ID == "Other")
                                            {
                                                ...
                                                script += "</script>\n";
                                                RegisterStartupScript("OtherSponsor_0", script);
                                            }
                                        }
                        ...
                        PrevART += "</script>\n";
                        RegisterStartupScript("PrevARTSponser", PrevART);
                    }
                ...
                if (theDS.Tables[3].Rows[0]["PrevHIVCare"] != System.DBNull.Value)
                {
                    if (Convert.ToInt32(theDS.Tables[3].Rows[0]["PrevHIVCare"]) == 1)
                    {
                                    ...
                                    foreach (Control ct in c.Controls)
                                    {
                                        ...
                                        else if (ct.GetType() == typeof(System.Web.UI.HtmlControls.HtmlInputText))
                                        {
                                            if (OtherCareType_ID == "Other")
                                            {
                                                ...
                                                script += "</script>\n";
                                                RegisterStartupScript("CareType_0", script);
                                            }
                                        }
                                    }
                                }
                        ...
                        Caretype += "</script>\n";
                        RegisterStartupScript("PrevCaretype", Caretype);
                    }
            ...
            if (theDS.Tables[2].Rows.Count > 0)
            {
                if (theDS.Tables[2].Rows[0]["EmergContactKnowsHIVStatus"] != System.DBNull.Value)
                {
                    if (Convert.ToInt32(theDS.Tables[2].Rows[0]["EmergContactKnowsHIVStatus"]) == 0)
                    {
                        ...
                        Statusscript += "</script>\n";
                        RegisterStartupScript("DiscussStatus_HIV", Statusscript);
                    ...
                    if (y.GetType() == typeof(System.Web.UI.HtmlControls.HtmlInputRadioButton))
                    {
                        if (y.ID == theDS.Tables[0].Rows[0]["ReferredFrom"].ToString())
                        {
                            if (y.ID == "61")
                            {
                                ...
                                RegisterStartupScript("afterotherfacility", ScriptOtherFacility);
    ...
    private void RecordSave_UpdateDQ()
    {
        ...
        script += "</script>\n";
        RegisterStartupScript("afterupdatefunction", script);
        return;
    }
    #endregion
    ...
    {
        IQCareMsgBox.NotifyAction("Enrollment saved successfully. Do you want to close?", "Enrollment Form", false, this, "window.location.href='frmPatient_History.aspx?sts=" + 0 + "';");
    ...
    {
        IQCareMsgBox.NotifyAction("Enrollment DQ Checked complete.Form Marked as DQ Checked. Do you want to close?", "Enrollment Form", false, this, "window.location.href='frmPatient_History.aspx?sts=" + 0 + "';");
        //string script = "<script language = 'javascript' defer ='defer' id = 'confirm'>\n";
        //script += "var ans;\n";
