...
public partial class ClinicalForms_frmFamilyInformation : BasePage
{
    IFamilyInfo PatientManager;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //if (Session["PNameHome"] != null)
        //{
        //    lblname.Text = Session["PNameHome"].ToString();
        //}
        //lblfileno.Text = "";
        //if (Session["PEnrollmentHome"] != null)
        //{
        //    lblpatientid.Text = Session["PEnrollmentHome"].ToString();
        //}
        //if (Session["PClinicIDHome"] != null)
        //{
    ...
    //protected void grdFamily_RowCommand(object sender, GridViewCommandEventArgs e)
    //{
    ...
    {
        IQCareMsgBox.NotifyAction("Family Information saved successfully. Do you want to close?", "Family Information Form", false, this, "window.location.href='frmPatient_Home.aspx';");
        ...
        //script += "else \n";
        //script += "{\n";
        //script += "window.location.href('../ClinicalForms/frmFamilyInformation.aspx?name=Edit');\n";
        //script += "}\n";
        //script += "</script>\n";
