            ...
            <tr>
                <td colspan="2" class="border pad5 whitebg">
                    <table>
                        <tr>
                            <td align="left">
                                <asp:Label ID="lblSexuallyActiveLast6Months" runat="server" Text="Have you been sexually active in the past 6 months?:"
                                    Font-Bold="True" CssClass="required"></asp:Label>
                            </td>
                            <td align="left">
                        ...
                        <table class="tbl-left" width="100%">
                            <tr>
                                <td align="right" width="75%">
                                    <asp:Label ID="lblDisclosedToSexualPartner" runat="server" Text="Have you disclosed your status to sexual partner:"
                                        Font-Bold="True" CssClass="required"></asp:Label>
                                </td>
                ...
                <td width="50%" class="border pad5 whitebg" id="DIVStatusSexualPartner" style="display: none;">
                    <div>
                        <table class="tbl-right">
                            <tr>
                                <td align="right" class="data-lable">
                                    <asp:Label ID="lblStatusOfSexualPartner" runat="server" Text="HIV Status of sexual partner:"
                                        Font-Bold="True" CssClass="required"></asp:Label>
                                </td>
                                <td align="left" class="data-control">
                                ...
                                <table width='100%'>
                                    <tr>
                                        ...
                                        <td style='width: 60%' align='left'>
                                            <asp:RadioButtonList ID="radbtnLMP" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="radbtnLMP_SelectedIndexChanged">
                                                <asp:ListItem Text="Yes" Value="1"></asp:ListItem>
                                                <asp:ListItem Text="No" Value="0"></asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                ...
                                <table id="DIVLMPDate" style="display: none" width="100%">
                                    <tr>
                                        ...
                                        <td align="left" width="50%">
                                            <input id="txtLMPDate" onfocus="javascript:vDateType='3'" maxlength="11" size="11"
                    ...
                    <table>
                        <tr>
                            <td align="left">
                                ...
                                <img alt="Date Helper" border="0" height="22" hspace="3" onclick="w_displayDatePicker('<%= txtEDD.ClientID%>');"
                ...
                <td width="50%" class="border pad5 whitebg">
                    <table class="tbl-right">
                        <tr>
                            ...
                            <td align="left" class="data-control">
                                <asp:CheckBox ID="chkUrethralDischarge" runat="server" OnCheckedChanged="chkUrethralDischarge_CheckedChanged" />
                            </td>
                        </tr>
                    </table>
                </td>
                <td width="50%" class="border pad5 whitebg">
                    <table class="tbl-left">
                        <tr>
                            ...
                            <td align="left" class="data-control">
                                <asp:CheckBox ID="chkVaginalDischarge" runat="server" OnCheckedChanged="chkVaginalDischarge_CheckedChanged" />
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr id="DIVGenUlceration" style="display: none">
                <td width="50%" class="border pad5 whitebg">
                    <table class="tbl-right">
                        <tr>
                            ...
                            <td align="left" class="data-control">
                                <asp:CheckBox ID="chkGenitalUlceration" runat="server" OnCheckedChanged="chkGenitalUlceration_CheckedChanged" />
                            </td>
                        </tr>
                    </table>
                </td>
                <td width="50%" class="border pad5 whitebg">
                    <table class="tbl-left" width="100%">
                        ...
                        <tr>
                            <td align="left" class="data-control">
                                <asp:TextBox ID="txtSTITreatmentPlan" runat="server" Skin="MetroTouch" Rows="3" TextMode="MultiLine"
            ...
            <tr id="STITreatmentOther" style="display: none">
                <td colspan="2" class="border pad5 whitebg">
                    <table width="100%">
                        <tr>
                            <td align="left">
                                <asp:Label ID="Label1" runat="server" Text="Other STI Treatment" Font-Bold="True"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                                <asp:TextBox ID="txtOtherSTITreatment" runat="server" Rows="3" TextMode="MultiLine"
                                    Width="100%"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" style='width: 30%'>
                                            <asp:RadioButtonList ID="radbtnReferredForCervicalCancerScreening" runat="server"
                                                RepeatDirection="Horizontal" OnSelectedIndexChanged="radbtnReferredForCervicalCancerScreening_SelectedIndexChanged">
                                                <asp:ListItem Text="Yes" Value="1"></asp:ListItem>
                                                <asp:ListItem Text="No" Value="0"></asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                ...
                <td colspan="2" class="border pad5 whitebg">
                    <table width="100%">
                        <tr>
                            <td align="left">
                                <label>
                                    Transition preparation (for 10 - 19 years old):</label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <table width="100%">
                                    ...
                                    <tr id="divReferToSpecialistClinic" style="display: none">
                                        <td align="left">
                                            <label>
                                                Refer to specialist clinic:</label><asp:TextBox ID="txtReferToSpecialistClinic" runat="server"
                                    ...
                                    <tr id="divReferToOther" style="display: none">
                                        <td align="left">
                                            <label>
                                                Specify other referral point:<asp:TextBox ID="txtSpecifyOtherRefferedTo" runat="server"
                                                    Skin="MetroTouch" Width="55%"></asp:TextBox>
                                            </label>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td valign="top" width="50%" id="DivCounselling" style="display: none">
                                <table width="100%">
                                    ...
                                    <tr id="divOtherCounselling" style="display: none">
                                        <td align="left">
                                            <label>
                                                Other:</label><asp:TextBox ID="txtOtherCounselling" runat="server" Width="70%"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
