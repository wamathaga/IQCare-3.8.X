...
<div class="center formbg">
    <asp:Panel ID="VitalSignsUserControlBody" runat="server">
        <table cellspacing="6" cellpadding="0" width="100%" border="0">
            <tbody>
                <tr>
                    <td class="form left" valign="middle">
                        <table width="100%">
                            <tr>
                                            ...
                                            <td align="left">
                                                <label>
                                                    Specify other referral point:<asp:TextBox ID="txtSpecifyOtherRefferedTo" runat="server"
                                                        Skin="MetroTouch" Width="60%"></asp:TextBox>
                                                </label>
                                            </td>
                                        </tr>
                                    </table>
