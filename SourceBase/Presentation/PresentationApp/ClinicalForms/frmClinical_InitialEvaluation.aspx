    ...
    <div class="container-fluid">
                        ...
                        <td id="tdPregnant" class="form" runat="server" colspan="2">
                            ...
                            <div id="spdelivery" style="display: none">
                                <label id="lbldelivered">
                                    Delivered since last visit:</label>
                                ...
                                <span id="spanDelDate" style="display: none">
                                    ...
                                    <img id="imgDelDate" onclick="w_displayDatePicker('<%=txtDeliDate.ClientID%>');"
                                        ...
                                        border="0" style="vertical-align: bottom; margin-bottom: 2px;" />
                                    <span class="smallerlabel">(DD-MMM-YYYY)</span> </span>
                            </div>
                        </td>
                    </tr>
        ...
        <div class="border center formbg">
            ...
            <table class="table-condensed" width="100%">
                <tbody>
                        ...
                        <td class="form" valign="top" style="width: 449px" align="left">
                            ...
                            <input id="rdoprevLowestCD4notdocumented" onmouseup="up(this);" onfocus="up(this);"
                                onclick="down(this);" type="radio" value="" name="prevLowestCD4none" runat="server" /><span
                                    class="smallerlabel">Not Documented</span><br />
                        ...
                        <td class="form" valign="top" width="50%" align="left">
                            ...
                            <div id="prevexpdiv" style="display: none;">
                                ...
                                <asp:Button ID="btnRegimen" runat="server" Text="..." OnClick="btnRegimen_Click"
                                    CssClass="btn btn-primary" Height="30px" />
                                ...
                                <input id="txtcurrentARTDate" maxlength="8" size="5" onkeyup="DateFormat(this,this.value,event,false,'4')"
                                    onfocus="javascript:vDateType='4'" name="currentARTDate" runat="server" /><span class="smallerlabel margin5">MMM-YYYY</span>
                                <br />
                                <br />
                                <label>
                                ...
                                <div id="prevARVReg" style="display: none">
                                    ...
                                    <input id="txtprevARVRegimen2Months" maxlength="7" size="5" name="prevARVRegimen2Months"
                                        runat="server" /><br />
                                    <label for="prevOtherRegimen1Name">
                                        Regimen:</label>
                                    ...
                                    <input id="txtprevARVRegimen3Months" maxlength="7" size="5" name="prevOtherRegimen1Months"
                                        runat="server" /><br />
                                    <label for="prevOtherRegimen2Name">
                                        Regimen:</label>
                    ...
                    <tr>
                        <td class="form" valign="top" colspan="2" style="height: 135px" align="left">
                            <label>
                            ...
                            <span id="lblHIVassociate" class="smallerlabel">Enter HIV-Associated Conditions</span><br />
        ...
        <div class="border center formbg">
            ...
            <table class="table-condensed" width="100%">
                <tbody>
                    <tr>
                        <td class="form" colspan="2" valign="middle">
                            <label id="TempVal">
                                Temp:
                                <input id="txtphysTemp" maxlength="4" size="4" name="physTemp" runat="server" /><span
                                    class="smallerlabel">C</span></label>
                            <label>
                                RR:<input id="txtphysRR" maxlength="4" size="4" name="physRR" runat="server" />
                                <span class="smallerlabel">bpm</span></label>
                            <label>
                                HR:
                                <input id="txtphysHR" maxlength="3" size="4" name="physHR" runat="server" /><span
                                    class="smallerlabel"> bpm</span></label>
                            <label>
                                BP:
                                <input id="txtphysBPSystolic" maxlength="4" size="4" name="physBPSystolic" runat="server" />
                                <b>/</b>
                                <input id="txtphysBPDiastolic" maxlength="4" size="4" name="physBPDiastolic" runat="server" /><span
                                    class="smallerlabel"> (mm/Hg)</span></label>
                            <label id="lblHT">
                                HT:
                                <input id="txtphysHeight" maxlength="4" size="4" name="physHeight" runat="server" />
                                <span class="smallerlabel">cm</span></label>
                            <label id="lblWT">
                                WT:
                                <input id="txtphysWeight" maxlength="4" size="4" name="physWeight" runat="server" />
                                <span class="smallerlabel">kg</span></label>
                            <label>
                                BMI:
                                <input id="txtanotherbmi" size="6" name="anotherbmi" runat="server" readonly="readonly" /></label>
                            <label>
                                Pain:<select id="ddlPain" name="pain" runat="server">
                    ...
                    <tr>
                        <td class="border pad5 whitebg" align="center">
                            ...
                            <img onclick="w_displayDatePicker('<%=txtappDate.ClientID %>');" height="22" alt="Date Helper"
                                ...
                                margin-bottom: 5px;" /><span class="smallerlabel" id="appDatespan">(DD-MMM-YYYY)</span>
                        </td>
                        <td class="border pad5 whitebg" align="center">
