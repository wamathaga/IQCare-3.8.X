...
/// /////////////////////////////////////////////////////////////////
/// 
public partial class ClinicalForms_frmClinical_PatientRegistrationCTC : BasePage
{
    ...
    private string DataQuality_Msg()
    {
        ...
        if (TxtPtnEnrollment.Text.Trim() == "")
        {
            ...
            script += "</script>\n";
            RegisterStartupScript("PtnID", script);
            MsgBuilder theBuilder = new MsgBuilder();
        ...
        if (TxtFirstName.Text.Trim() == "")
        {
            ...
            script += "</script>\n";
            RegisterStartupScript("Fname", script);
            MsgBuilder theBuilder = new MsgBuilder();
            theBuilder.DataElements["Control"] = " -First Name";
            strmsg += IQCareMsgBox.GetMessage("BlankTextBox", theBuilder, this);
            strmsg += "</br>";
        ...
        if (TxtLastName.Text.Trim() == "")
        {
            ...
            script += "</script>\n";
            RegisterStartupScript("Lname", script);
            MsgBuilder theBuilder = new MsgBuilder();
            theBuilder.DataElements["Control"] = " -Last Name";
            strmsg += IQCareMsgBox.GetMessage("BlankTextBox", theBuilder, this);
            strmsg += "</br>";
        ...
        if (TxtRegistrationDate.Text.Trim() == "")
        {
            ...
            script += "</script>\n";
            RegisterStartupScript("RegDate", script);
            MsgBuilder theBuilder = new MsgBuilder();
            theBuilder.DataElements["Control"] = " -Registration Date";
            strmsg += IQCareMsgBox.GetMessage("BlankTextBox", theBuilder, this);
            strmsg += "</br>";
        ...
        if (DDGender.SelectedValue.Trim() == "0")
        {
            ...
            script += "</script>\n";
            RegisterStartupScript("ddgender", script);
            MsgBuilder theBuilder = new MsgBuilder();
            theBuilder.DataElements["Control"] = " -Sex";
            strmsg += IQCareMsgBox.GetMessage("BlankTextBox", theBuilder, this);
            strmsg += "</br>";
        ...
        if (TxtDOB.Text.Trim() == "")
        {
            ...
            script += "</script>\n";
            RegisterStartupScript("DOB", script);
            MsgBuilder theBuilder = new MsgBuilder();
        ...
        if (DDPriorExposure.SelectedValue.Trim() == "265")
        {
            if (ddregimen.SelectedValue.Trim() == "0"  && TxtInitialRegimen.Text == "")
            {
                ...
                script += "</script>\n";
                RegisterStartupScript("ddregimen", script);
                MsgBuilder theBuilder = new MsgBuilder();
                theBuilder.DataElements["Control"] = " -Initial Regimen";
                strmsg += IQCareMsgBox.GetMessage("BlankTextBox", theBuilder, this);
                strmsg += "</br>";
    ...
    private void SaveCancel()
    {
        ...
        script += "else \n";
        script += "{\n";
        script += "window.location.href='frmClinical_PatientRegistrationCTC.aspx?name=Edit&sts=" + Session["fmsts"] + "';\n";
        script += "}\n";
        script += "</script>\n";
    ...
    private void UpdateCancel()
    {
        ...
        script += "if (ans==true)\n";
        script += "{\n";
        script += "window.location.href='frmPatient_History.aspx?sts=" + Session["fmsts"] + "';\n";
        script += "}\n";
        script += "else \n";
        script += "{\n";
        script += "window.location.href='frmClinical_PatientRegistrationCTC.aspx?name=Edit&sts=" + Session["fmsts"] + "';\n";
    ...
    private void DQCancel()
    {
        ...
        script += "else \n";
        script += "{\n";
        script += "window.location.href='frmClinical_PatientRegistrationCTC.aspx?name=Edit&sts=" + 0 + "';\n";
        script += "}\n";
        script += "</script>\n";
        RegisterStartupScript("confirm", script);
    ...
    private void ShowpriorExposure()
    {
        ...
        if (DDPriorExposure.SelectedItem.Text == "ART Transfer in (with records)")
        {
            ...
            script += "</script>\n";
            RegisterStartupScript("PriorExposure", script);
        }
    ...
    protected void AddUpdatePatient()
    {
        ...
        htParameters.Clear();
        if (Request.QueryString["Name"] == "Add" && Session["PatientId"] == null)
        {
            htParameters.Add("ptn_pk", "");

        }
        else if (Request.QueryString["Name"] == "Add" && Session["PatientId"] != null)
        {
            int patientID = Convert.ToInt32(Session["PatientId"]);
        ...
        else { htParameters.Add("Update", "0");
    ...
    protected void ScriptPriorExposure()
    {
        ...
        strPExp += "}\n";
        strPExp += "</script>\n";
        RegisterStartupScript("ConPExposure", strPExp);
    }
    protected void LoadPatientData()
    {
      if (Request.QueryString["name"] == "Edit")
      {
          ...
          string LocId1 = Session["AppCountryId"] + "-" + Session["AppPosID"] + "-" + Session["AppSatelliteId"];
           IPatientRegistration PtnMgrCTC = (IPatientRegistration)ObjectFactory.CreateInstance("BusinessProcess.Clinical.BPatientRegistration, BusinessProcess.Clinical");
           DataSet theDS = PtnMgrCTC.GetPatientDetailsCTC(Session["PatientId"].ToString(), "", "", "", "", 0, 0);
           ViewState["PtnID"] = Session["PatientId"].ToString();
          ...
          if (DDReferredFrom.SelectedItem.Text == "Other")
          {
              ...
              script += "</script>\n";
              RegisterStartupScript("ReferredFrom", script);
          }
    ...
    protected void btnDQ_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (Request.QueryString["name"] == "Edit" && ViewState["PtnID"] != null)
            {
                if (Session["status"] == "Add") { DQCancel(); }
                else { DQUpdateCancel(); }
            }
