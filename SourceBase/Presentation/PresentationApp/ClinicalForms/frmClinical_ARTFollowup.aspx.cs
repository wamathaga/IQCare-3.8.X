...
/// /////////////////////////////////////////////////////////////////
/// 
public partial class frmClinical_ARTFollowup : BasePage, ICallbackEventHandler
{
    ...
    private string DataQuality_Msg()
    {
        ...
        if (txtvisitDate.Value.Trim() == "")
        {
            ...
            scriptVdate += "</script>\n";
            RegisterStartupScript("Vdate_ID", scriptVdate);
            MsgBuilder theBuilder = new MsgBuilder();
            theBuilder.DataElements["Control"] = " -Visit Date";
        ...
        if (chMissedLastWeeknone.Checked == false)
        {
            if (txtMissedLastWeek.Value.Trim() == "" || count == 0)
            {
                ...
                RegisterStartupScript("MissLast_ID", scriptmisslastdate);
                MsgBuilder theBuilder = new MsgBuilder();
        ...
        if ((rdoARVSideEffectsNone.Checked == false) && (rdoARVSideEffectsNotDocumented.Checked == false) && (rdoARVSideEffectsYes.Checked == false))
        {
            ...
            RegisterStartupScript("ARVSideEffect_ID", scriptSideEffect);
            MsgBuilder theBuilder = new MsgBuilder();
        ...
        if ((rdoOIsAIDsIllnessNone.Checked == false) && (rdoOIsAIDsIllnessNotDocumented.Checked == false) && (rdoOIsAIDsIllnessYes.Checked == false))
        {
            ...
            RegisterStartupScript("OIsAIDs_ID", scriptOIsAIDs);
            MsgBuilder theBuilder = new MsgBuilder();
        ...
        if (cblAssessment.SelectedValue == "")
        {
            ...
            RegisterStartupScript("Assessment_ID", scriptassessment);
            MsgBuilder theBuilder = new MsgBuilder();
        ...
        if (lstclinPlanFU.Value.ToString() == "0" && Session["Paperless"].ToString() == "0")
        {
            ...
            RegisterStartupScript("ARVplan_ID", scriptARVplan);
            MsgBuilder theBuilder = new MsgBuilder();
    ...
    private void Load_data()
    {
        ...
        if (theDS1.Tables[1].Rows.Count > 0)
        {
            ...
            if (theDS1.Tables[1].Rows[0]["Delivered"] != System.DBNull.Value)
            {
                if (Convert.ToInt32(theDS1.Tables[1].Rows[0]["Delivered"]) == 0)
                {
                    ...
                    script += "show('spanEDD');\n";
                    script += "</script>\n";
                    RegisterStartupScript("DeliveredNo", script);
                ...
                else if (Convert.ToInt32(theDS1.Tables[1].Rows[0]["Delivered"]) == 1)
                {
                    ...
                    script += "hide('spanEDD');\n";
                    script += "</script>\n";
                    RegisterStartupScript("DeliveredYes", script);
        ...
        if (theDS1.Tables[2].Rows.Count > 0)
        {
            if (theDS1.Tables[2].Rows[0]["MissedLastWeek"] == System.DBNull.Value)
            {
                ...
                script += "</script>\n";
                RegisterStartupScript("LastWeek", script);
            }
            else
            {
            ...
            if (theDS1.Tables[2].Rows[0]["MissedLastMonth"] == System.DBNull.Value)
            {
                ...
                script += "</script>\n";
                RegisterStartupScript("LastMonth", script);
            }
            else
            {
            ...
            if (theDS1.Tables[2].Rows[0]["InterruptedDate"] != System.DBNull.Value)
            {
                ...
                script += "</script>\n";
                RegisterStartupScript("Interrupted1", script);
            ...
            if (theDS1.Tables[2].Rows[0]["InterruptedNumDays"] != System.DBNull.Value)
            {
                ...
                script += "show('interruptedDate');\n";
                script += "</script>\n";
                RegisterStartupScript("Interrupted2", script);
                rdoInterrupted.Checked = true;
            }
            ...
            if (theDS1.Tables[2].Rows[0]["StoppedDate"] != System.DBNull.Value)
            {
                ...
                script += "</script>\n";
                RegisterStartupScript("Stopped1", script);
            ...
            if (theDS1.Tables[2].Rows[0]["StoppedNumDays"] != System.DBNull.Value)
            {
                ...
                script += "show('stopDate');\n";
                script += "</script>\n";
                RegisterStartupScript("Stopped2", script);
                rdostopped.Checked = true;
            }
        ...
        if (theDS1.Tables[3].Rows.Count > 0)
        {
            ...
            {
                string aWeight = theDS1.Tables[3].Rows[0]["Weight"].ToString();
                string aHeight = theDS1.Tables[3].Rows[0]["Height"].ToString();

                if (string.IsNullOrEmpty(aWeight) == false && string.IsNullOrEmpty(aHeight) == false)
                {
                    decimal anotherWeight = Convert.ToDecimal(aWeight);
                    decimal anotherHeight = Convert.ToDecimal(aHeight);
                        ...
                        foreach (Control ct in c.Controls)
                        {
                            ...
                            else if (ct.GetType() == typeof(System.Web.UI.HtmlControls.HtmlInputText))
                            {
                                if (OtherMissedReason == "Other")
                                {
                                    ...
                                    script += "</script>\n";
                                    RegisterStartupScript("ReasonMissed_0", script);
                                }
                            }
            ...
            for (int i = 0; i < theDS1.Tables[7].Rows.Count; i++)
            {
                ...
                for (int j = 0; j < cblARVSideEffectleft.Items.Count; j++)
                {
                    if (cblARVSideEffectleft.Items[j].Value == theDS1.Tables[7].Rows[i]["SymptomID"].ToString())
                    {
                        ...
                        script += "</script>\n";
                        RegisterStartupScript("cblARVSideEffect_ID", script);
                    }
                }
            }
        ...
        for (int i = 0; i < theDS1.Tables[7].Rows.Count; i++)
        {
            ...
            else if (TBScreen == 70)
            {
                ...
                script += "</script>\n";
                RegisterStartupScript("cblTBScreen_ID", script);
            }
        ...
        if (theDS1.Tables[8].Rows.Count > 0)
        {
            for (int i = 0; i < theDS1.Tables[8].Rows.Count; i++)
            {
                ...
                if (OIsAIDsIllness == 99)
                {
                    ...
                    script += "</script>\n";
                    RegisterStartupScript("cblOIsAIDs_ID_None", script);
                }
                else if (OIsAIDsIllness == 98)
                {
                    ...
                    script += "hide('otherOIsAIDs');\n";
                    script += "</script>\n";
                    RegisterStartupScript("cblOIsAIDs_ID_Notdocumented", script);
                }
                    ...
                    if (ct.GetType() == typeof(System.Web.UI.HtmlControls.HtmlInputCheckBox))
                    {
                        if (((HtmlInputCheckBox)ct).Value == "Other")
                        {
                            if (((HtmlInputCheckBox)ct).Checked == true)
                            {
                                ...
                                script += "show('otherRMissed');\n";
                                script += "</script>\n";
                                RegisterStartupScript("OIsAIDs_ID_2", script);
                            }
                        }
                    }
                }
    ...
    {
        if (ViewState["MissedLastWeeknone"] == "1")
        {
            ...
            RegisterStartupScript("onMissedLastWeeknone", scriptMissedLastWeeknone);
        }

        if (ViewState["MissedLastMonthnone"] == "1")
        {
            ...
            RegisterStartupScript("onMissedLastMonthnone", scriptMissedLastMonthnone);
        }

        if (ViewState["Interrupted"] == "1")
        {
            ...
            RegisterStartupScript("onInterrupted", scriptInterrupted);

        }

        if (ViewState["Stopped"] == "1")
        {
            string scriptStopped = "<script language = 'javascript' defer ='defer' id = 'onStopped'>\n";
            scriptStopped += "show('stopDate'); \n";
            scriptStopped += "</script>\n";
            RegisterStartupScript("onStopped", scriptStopped);
        ...
        if (ViewState["ARVSideEffectsYes"] == "1")
        {
            ...
            RegisterStartupScript("onARVSideEffectsYes", scriptARVSideEffectsYes);
        }

        if (ViewState["OIsAIDsIllnessYes"] == "1")
        {
            ...
            RegisterStartupScript("onOIsAIDsIllnessYes", scriptOIsAIDsIllnessYes);
        }
        if (ViewState["TBScreenYes"] == "1")
        {
            ...
            RegisterStartupScript("TBScreenYes", scriptTBScreenYes);
        }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Convert.ToInt32(Session["PatientVisitId"]) == 0)
            {
                ...
                theDQ.DataElements["Name"] = "DQ Checked complete. Form Marked as DQ Checked. Do you want to close";
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        else if (Request.QueryString["name"] == "Delete")
        {
            if (Authentiaction.HasFunctionRight(ApplicationAccess.ARTFollowup, FunctionAccess.View, (DataTable)Session["UserRight"]) == false)
            {
                ...
                string theUrl = "";
                theUrl = string.Format("{0}?sts={1}", "frmClinical_DeleteForm.aspx", Request.QueryString["sts"].ToString());
                Response.Redirect(theUrl);
            }
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Convert.ToInt32(Session["PatientVisitId"]) < 1)
            {
                ...
                DataSet theDSAdd1 = FUManager.GetPatient_No_Of_VisitDate(PatientID, txtvisitDate.Value, 2);
    ...
    {
        int PatientID = Convert.ToInt32(Session["PatientId"]);
        IQCareMsgBox.NotifyAction("ART FollowUp Form saved successfully. Do you want to close?", "ART FollowUp Form", false, this, "window.location.href='frmPatient_History.aspx?sts=" + 0 + "';");
