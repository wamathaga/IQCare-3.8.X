    ...
    <div class="container-fluid">
        <div class="border center formbg">
            <table width="100%" class="table-condensed">
                <tbody>
                    <tr>
                        <td class="border whitebg" width="50%">
                            ...
                            <input id="txtvisitDate" maxlength="11" size="8" name="visitDate" runat="server"
                                onblur="javascript:SendCodeName();" onchange="SendCodeName();" onfocus="SendCodeName();" />
                            <img onclick="w_displayDatePicker('<%= txtvisitDate.ClientID%>');SendCodeName();"
                                height="22" alt="Date Helper" hspace="5" src="../images/cal_icon.gif" width="22"
                                border="0" style="vertical-align: sub;" /><span class="smallerlabel">(DD-MMM-YYYY)</span>
                        ...
                        <td class="border whitebg">
                            ...
                            <img id="ImgCD4" onclick="w_displayDatePicker('<%=txtTestResultsDate.ClientID%>')"
                                height="22" alt="Date Helper" hspace="5" src="../images/cal_icon.gif" width="22"
                                border="0" runat="server" style="vertical-align: sub;" />
                            <span class="smallerlabel">(DD-MMM-YYYY)</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="border whitebg left">
                    ...
                    <tr>
                        <td class="border whitebg" align="center">
                            <label for="RegimenType">
                                Regimen:</label>
                            <input id="txtRegimenType" readonly="readonly" runat="server" />
                        </td>
                        <td class="border whitebg" align="center" width="50%">
                            <label>
                                ...
                                <label>
                                    No</label></span> <span id="spanEDD" style="display: none">
                                        ...
                                        <img id="imgEDD" onclick="w_displayDatePicker('<%=txtEDDDate.ClientID%>');" height="22"
                                            ...
                                            style="vertical-align: sub;" />
                                        <span class="smallerlabel">(DD-MMM-YYYY)</span> </span><span id="spdelivery" style="display: none">
        ...
        <div class="border center formbg">
            ...
            <table width="100%" class="table-condensed">
                <tbody>
                    <tr>
                        <td class="border whitebg" style="width: 50%;">
                            <table width="100%" class="table-condensed">
                                <tr>
                                    <td align="left">
                                        <label>
                        ...
                        <td class="border whitebg" style="width: 50%;" align="left">
                            <table width="100%" class="table-condensed">
                                <tr>
                                    <td>
                                        <label>
                                            DOT:</label>
                                        <span>
                                            <asp:TextBox ID="txtNumDOTPerWeek" runat="server" MaxLength="4" Width="30" Style="margin-left: 20%;"></asp:TextBox>
                                            <span class="smalllabel">times/week</span></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <label>
                                            Home Visits:</label>
                                        <span>
                                            <asp:TextBox ID="txtNumHomeVisitsPerWeek" runat="server" MaxLength="4" Width="30"
                                                Style="margin-left: 10%;"></asp:TextBox>
                                            <span class="smalllabel">times/week</span></span>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table width="100%" class="table-condensed">
                                    ...
                                    <td align="left">
                                        <div>
                                            ...
                                            <input type="radio" id="rdoInterrupted" name="intStop" value="interrupted" runat="server"
                                                onmouseup="up(this);" onfocus="up(this);" onclick="down(this); toggle('interruptedDate'); hide('stopDate');" /></div>
                                ...
                                <tr>
                                    <td align="left">
                                        ...
                                        <div id="stopDate" style="display: none; margin-left: 20%;">
                                            <label>
                                                Date:
                                            </label>
                                            ...
                                            <img onclick="w_displayDatePicker('<%=txtstoppedDate.ClientID%>');" height="22" alt="Date Helper"
                                                ...
                                                margin-bottom: 2px;" /><span class="smallerlabel">(DD-MMM-YYYY)</span>
        ...
        <div class="border center formbg">
            ...
            <table width="100%" class="table-condensed">
                <tbody>
                    <tr>
                        <td class="border whitebg" width="50%" colspan="2" align="left">
                            <label>
                                ...
                                <tr>
                                    <td>
                                        <label id="lblassessment">
                                            ...
                                            <span>
                                                <asp:CheckBoxList ID="cblAssessment" runat="server" RepeatLayout="Table" RepeatDirection="Horizontal"  Width="150%" RepeatColumns="4" >
                                                </asp:CheckBoxList>
                                            </span>
                                        </div>
                                    </td>
                    ...
                    <tr>
                        <td class="border pad5 whitebg" align="center" valign="top">
                            ...
                            <img onclick="w_displayDatePicker('<%=txtappDate.ClientID %>');" height="22" alt="Date Helper"
                                hspace="5" src="../images/cal_icon.gif" width="22" border="0" style="vertical-align: bottom;
                                margin-bottom: 2px;" /><span class="smallerlabel" id="appDatespan">(DD-MMM-YYYY)</span>
                        </td>
                    ...
                    <tr>
                        <td class="pad5 center" colspan="2">
                            ...
                            <asp:Button ID="btnOk" Text="OK" CssClass="textstylehidden" runat="server"
                                OnClick="theBtn_Click" Width="8%" Height="30px" Style="text-align: left;" />
                            <label id="lblOKClick" class="glyphicon glyphicon-ok-sign" runat ="server"  style="margin-left: -4%; margin-right: 3%;
                            ...
                            <asp:Button ID="theBtnDQ" Text="DQ" CssClass="textstylehidden" runat="server"
                                OnClick="theBtnDQ_Click" Width="8%" Height="30px" Style="text-align: left;" />
                            <label id="lblDQClick" class="glyphicon glyphicon-random" runat ="server" style="margin-left: -4%; margin-right: 3%;
                                vertical-align: middle; color: #fff; margin-top: .6%; visibility: hidden;">
                            </label>
