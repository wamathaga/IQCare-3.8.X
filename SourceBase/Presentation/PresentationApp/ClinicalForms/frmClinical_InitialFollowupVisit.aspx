...
<asp:Content ID="Content1" ContentPlaceHolderID="IQCareContentPlaceHolder" runat="Server">
    ...
    <div class="container-fluid">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="border pad5 whitebg" align="center">
                            <label class="center">
                                Visit Type:</label>
                            <asp:DropDownList ID="ddlvisittype" runat="server" onchange="fnTreamentProgram();">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="border pad5 whitebg formcenter" align="center" colspan="2">
                            ...
                            <span class="smalllabel">Months</span> <strong>Starting Current Regimen </strong>
        ...
        <br />
        <div id="divClinicalStatus" class="border center formbg">
            <br />
        ...
        <br />
        <div id="divtreatmentRef" class="border center formbg">
            <br />
        ...
        <br />
        <div id="divtreatmentPwp" class="border center formbg">
            <br />
            <h4 id="H4" class="forms" align="left">
                Positive Prevention
            </h4>
            <table class="table-condensed" cellspacing="6" cellpadding="0" width="100%" border="0">
                <tbody>
                    <tr>
                    ...
                    <tr>
                        <td class="pad5 center whitebg border" colspan="2">
                            ...
                            <asp:Button ID="btnDataQualityCheck" Text="Data Quality check" runat="server" OnClick="btnDataQualityCheck_Click"
                                CssClass="btn btn-primary" Height="30px" Width="18%" Style="text-align: left;" /><label
