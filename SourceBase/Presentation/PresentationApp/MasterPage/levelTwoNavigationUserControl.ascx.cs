    ...
    private void Load_MenuCreateNewForm()
    {
        ...
        foreach (DataRow theDR in dtrules.Rows)
        {
            if (Convert.ToInt32(theDR["Featureid"]) != 71)
            {
                ...
                {
                    DivDynModule(); divKenyaBlueCard(); divUgandaBlueCard(); divKHN(); divPEP(); ClinicID(); divNigARTCard(); divKNHDCC();
                ...
                {
                    DivDynModule(); divKenyaBlueCard(); divUgandaBlueCard(); divKHN(); divPEP(); divPMTCT(); divNigARTCard(); divKNHDCC();
                    LoadCreateNewMenu(theURL, rowNo);
                    if (lblpntStatus.Text != "1")
                    {
                ...
                {
                    DivDynModule(); divKenyaBlueCard(); ClinicID(); divKHN(); divPEP(); divPMTCT(); divNigARTCard(); divKNHDCC();
                    if (lblpntStatus.Text != "1")
                    {
                        if (theLabTest != "")
                        {
                ...
                {
                    DivDynModule(); ClinicID(); divPMTCT(); divPEP(); divNigARTCard(); divKNHDCC();
                ...
                {
                    DivDynModule(); ClinicID(); divPMTCT(); divKHN(); divNigARTCard(); divKNHDCC();
                    if (lblpntStatus.Text != "1")
                    {
                        if (theLabTest != "")
                        {
                ...
                {
                    DivDynModule(); ClinicID(); divPMTCT(); divPEP(); divKHN(); divUgandaBlueCard(); divKNHDCC();
                    if (Convert.ToDecimal(Session["PatientAge"]) >= 15)
                    {
                        RemoveMenuItemByValue(patientLevelMenu.Items, "mnunigPaedIE");                        
                    }
