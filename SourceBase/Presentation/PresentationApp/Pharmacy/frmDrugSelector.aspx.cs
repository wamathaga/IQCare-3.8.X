...
public partial class frmDrugSelector : System.Web.UI.Page
{
    string theCntrlName = "";
    string[] ControlId;
    ...
    private DataTable CreateSelectedTable()
    {
        ...
        theDT.Columns.Add("Generic", System.Type.GetType("System.String"));
        ...
        if (DTSelected != null && DTSelected.Rows.Count > 0)
        {
            foreach (DataRow dr1 in DTSelected.Rows)
            {
                foreach (DataRow dr in theDT.Rows)
                {
                    ...
                    if ((Convert.ToInt32(dr1["DrugId"]) == Convert.ToInt32(dr["DrugId"])))
                    {
    ...
    {
        if (Session["PtnRegCTC"] == "PtnRegCTC")
        {
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //Application["MasterData"] = Session["DrugData"]; -- Commented by Jayant on 19/01/2015
            string theScript;
            theScript = "<script language='javascript'id='DrgPopup'>\n";
            theScript += "window.opener.GetControl();\n";
            theScript += "window.close();\n";
            theScript += "</script>\n";
            Page.RegisterStartupScript("Done", theScript);
        }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            theDR[2] = theDR1[0][2];
            theDR[3] = theDR1[0][4];
            theDR[4] = string.Empty;// theDR1[0][3];
            theDT.Rows.Add(theDR);
