...
public partial class Reports_frmIQToolsReports : LogPage
{
    /// <summary>
    /// The no data flag
    /// </summary>
    ...
    protected void gridResult_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (!hasTemplate)
            {
                LinkButton button = e.Row.Cells[3].Controls.OfType<LinkButton>().DefaultIfEmpty(null).FirstOrDefault();
                if (button != null)
