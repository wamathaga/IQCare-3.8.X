...
{
    public partial class frmIQToolsQuery : LogPage
    {
        /// <summary>
        /// The no data flag
        /// </summary>
        ...
        /// </summary>
        bool isError = false;
        IReportIQQuery theQueries = (IReportIQQuery)ObjectFactory.CreateInstance("BusinessProcess.Reports.IQToolsQueries, BusinessProcess.Reports");
        /// <summary>
