            ...
            <table width="100%" class="table-condensed">
                <tbody>
                    ...
                    <tr id="Artandnonart" runat="server">
                        <td colspan="2" class="form center" style="width: 100%;">
                            <div>
                    ...
                    <tr>
                        ...
                        <td class="form" id="tdCareEndDate" align="center" valign="top" visible="true" style="width: 50%;">
                            ...
                            <img onclick="w_displayDatePicker('<%=txtCareEndDate.ClientID %>');" height="22"
                                ...
                                id="IMG1" style="vertical-align: sub;" />
