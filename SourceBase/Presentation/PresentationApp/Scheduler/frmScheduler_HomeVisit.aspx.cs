...
public partial class frmScheduler_HomeVisit : LogPage
{
    /////////////////////////////////////////////////////////////////////
    ...
    string enroll, theCreateDate;
    DateTime theStartDate, theDt, theCurrentDate, theIEDate;
    int theNumofWeeks, theFlag, theTotVisit = 0, theCount = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            ViewState["Patientid"] = Convert.ToInt32(Session["PatientId"]);
            ...
            if (Convert.ToUInt32(Session["PatientVisitId"]) == 0)
            {
                ...
                ////////IQCareMsgBox.ShowConfirm("HomeVisit", theDQ, theBtn1);

                ////////theBuilder.DataElements["FormName"] = "Home Visit Record";
                ////////IQCareMsgBox.ShowConfirm("HomeVisitSave", theBuilder, theBtn);
            }
            else if (lblH2.Text == "Delete")
            {
                lblH2.Text = "Delete Home Visit";
                ViewState["theHomeVisitID"] = Convert.ToInt32(Session["PatientVisitId"]); ////Convert.ToInt32(Request.QueryString["OrderId"]);
                btnSave.Text = "Delete";
            ...
            else //if (lblH2.Text == "Edit")
            {
                ...
                ////ViewState["theHomeVisitID"] = Convert.ToInt32(Request.QueryString["OrderId"]);
                ////////theDQ.DataElements["Name"] = "DQ Checked complete.\\n Form Marked as DQ Checked.\\n Do you want to close";
                ////////IQCareMsgBox.ShowConfirm("HomeVisit", theDQ, theBtn1);

                ////////theBuilder.DataElements["FormName"] = "Home Visit Record";
                ////////IQCareMsgBox.ShowConfirm("HomeVisitUpdate", theBuilder, theBtn);
            }
        ...
        //if ((Request.QueryString["name"] != "Add") || (Request.QueryString["name"] == "Delete"))
    ...
    /************** Validate Function For DataQuality *************/
    ...
    private string DQValidation1()
    {
        ...
        if (StartDate.Value == "")
        {
            ...
            RegisterStartupScript("ColorVisitDate", scriptHomeVisitDate);
            MsgBuilder theBuilder = new MsgBuilder();
            theBuilder.DataElements["Control"] = "-Start Date";
    ...
    /************ Check if numofweeks and numofvisitsperweek is blank *********/
    ...
    private void ShowHideData(int theWeeks)
    {
        if (theWeeks.ToString() != "")
        {
            ...
            script += "</script>\n";
            RegisterStartupScript("ShowWeeks", script);
        }
        if (theWeeks.ToString() == "1")
        {
            ...
            script += "</script>\n";
            RegisterStartupScript("ShowWeeks1", script);
        }
        else if (theWeeks.ToString() == "2")
        {
            ...
            script1 += "</script>\n";
            RegisterStartupScript("ShowWeeks2", script1);
        ...
        else if (theWeeks.ToString() == "3")
        {
            ...
            script3 += "</script>\n";
            RegisterStartupScript("ShowWeeks3", script3);
        }
        else if (theWeeks.ToString() == "4")
        {
            ...
            script4 += "</script>\n";
            RegisterStartupScript("ShowWeeks4", script4);
    ...
    private void fillDropDownList(int idCHW, int idAlternateCHW)
    {
        ...
        */
        ...
        BindUserDropdown(ddlCHW, string.Empty);
        BindUserDropdown(ddlAlternateCHW, string.Empty);
    }
    ...
    private void DQCancel()
    {
        string script = "<script language = 'javascript' defer ='defer' id = 'confirm'>\n";
        script += "var ans;\n";
        script += "ans=window.confirm('DQ Checked complete. Form Marked as DQ Checked. Do you want to close?');\n";
        script += "if (ans==true)\n";
        script += "{\n";
        //if (Request.QueryString["Name"] == "Add")
        if (Convert.ToUInt32(Session["PatientVisitId"]) == 0)
    ...
    private void Save()
    {
        ...
        try
        {
            ...
            if ((ViewState["theSaveDS"] == null) || (theViewDS.Tables.Count == 0))
            {
                ...
                {
                    SaveCancel();
                    //////string script = "<script language = 'javascript' defer ='defer' id = 'aftersavefunction1'>\n";
                    //////script += "document.getElementById('" + theBtn.ClientID + "').click();\n";
                    //////script += "</script>\n";
                    //////RegisterStartupScript("aftersavefunction1", script);
                    return;
                }
    ...
    private void FillOldData(Int32 PatID)
    {
        ...
        try
        {
            ...
            ////dsvalues = CustomFields.GetCustomFieldValues("dtl_CustomField_" + theTblName.ToString().Replace("-", "_"), theColName, Convert.ToInt32(PatID.ToString()), Convert.ToInt32(Request.QueryString["OrderId"]), 0, 0, 0, Convert.ToInt32(ApplicationAccess.HomeVisit));
